        ...
        VStack
        {
            ...
            HStack{
                ...
                Text("TSE Part A: \(typesA[QuartzDB.BCoat2PtA]), 1 gal")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSABC_QuartzTS) + QuartzDB.BCoat2Waste)")
                    .font(.caption)
            }
            ...
            HStack{
                ...
                Text("Top Shelf® Epoxy Part B: \(typesB[QuartzDB.BCoat2PtB]), 1/2 gal")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSBBC_QuartzTS) + QuartzDB.BCoat2Waste)")
                    .font(.caption)
            }
            if QuartzDB.BCoat2TSColorant != 0
            {
                HStack {
                    ...
                    Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[QuartzDB.BCoat2TSColorant]), 16 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSColorantBC_QuartzTS) + QuartzDB.BCoat2Waste)")
                        .font(.caption)
                }
            }
...
struct QuartzDBBCoat2Sum_Previews: PreviewProvider {
