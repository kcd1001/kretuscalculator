...
struct ColorQuartzDBTopCoat: View {
    ...
    func updateCovRate() -> Void
    {
        ...
        else if QuartzDB.Coat4ProductType == 1
        {
    ...
    func checkPCoatCodes() -> Void {
        ...
        if QuartzDB.Coat4PtA == 0 && QuartzDB.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY72AZ-01"
            PCoatHardenerCode = "EX-KPLY72B-01"
        }
        else if QuartzDB.Coat4PtA == 0 && QuartzDB.Coat4PtB == 1 {
            PCoatPtACode = "EX-KPLY72AF-01"
            PCoatHardenerCode = "EX-KPLY72B-01"
            
        }
        else if QuartzDB.Coat4PtA == 1 && QuartzDB.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY85AZ-01"
            PCoatHardenerCode = "EX-KPLY85B-01"
        }
        else if QuartzDB.Coat4PtA == 1 && QuartzDB.Coat4PtB == 1 {
            PCoatPtACode = "EX-KPLY85AF-01"
            PCoatHardenerCode = "EX-KPLY85B-01"
            
        }
        else if QuartzDB.Coat4PtA == 2 && QuartzDB.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY92AZ-01"
            PCoatHardenerCode = "EX-KPLY92B-01"
            
        }
        else if QuartzDB.Coat4PtA == 2 && QuartzDB.Coat4PtB == 1 {
        ...
        VStack {
            HStack {
                Text("Top Coat Product:")
                    .fontWeight(.bold)
                Picker(selection: $QuartzDB.Coat4ProductType,
                       label: ZStack {
                    Text("\(products[QuartzDB.Coat4ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
 ...
 //               SplashTSFloorInfo()
            ...
            HStack {
                Toggle(isOn: $QuartzDB.Coat4MatAdd, label: {
            ...
            Text("Top Shelf Epoxy® Part A:")
                .fontWeight(.bold)
            Picker(selection: $QuartzDB.Coat4PtA,
                   label: ZStack {
                Text("\(typesA[QuartzDB.Coat4PtA])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            Text("Top Shelf Epoxy® Part B:")
                .fontWeight(.bold)
            Picker(selection: $QuartzDB.Coat4PtB,
                   label: ZStack {
                Text("\(typesB[QuartzDB.Coat4PtB])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            //             .onChange(of: QuartzDB.Coat4PtB) { _ in
            //                 CheckCoatChoices()
            //             }
            Text("Top Shelf Epoxy® Colorant:")
                .fontWeight(.bold)
            Picker(selection: $QuartzDB.Coat4TSColorant,
                   label: ZStack {
                Text("\(TSColorantChoices[QuartzDB.Coat4TSColorant])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            else if QuartzDB.Coat4ProductType == 1
            {
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                .onChange(of: QuartzDB.Coat4PtA) { _ in
                    checkPCoatCodes()
                }
                
                Picker(selection: $QuartzDB.Coat4PtB,
                       label: ZStack {
                    Text("\(hardeners[QuartzDB.Coat4PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            if QuartzDB.Coat4ProductType != 0
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $QuartzDB.Coat4PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[QuartzDB.Coat4PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            Text("Texture:")
                .fontWeight(.bold)
            Picker(selection: $QuartzDB.Coat4Texture,
                   label: ZStack {
                Text("\(TextureOptions[QuartzDB.Coat4Texture])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            .onChange(of: QuartzDB.Coat4Texture) { _ in
                checkTexture()
            }
            ...
            VStack { // Start of coat summary
                ...
                if QuartzDB.Coat4ProductType == 0
                {
                if QuartzDB.Coat4PtA == 4 {
                    HStack{
                        Text("\(typesACodes[QuartzDB.Coat4PtA])")
                            .font(.caption)
                        Spacer()
                    ...
                    HStack{
                        Text("\(typesACodes[QuartzDB.Coat4PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: \(typesA[QuartzDB.Coat4PtA]), 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: quartzTS_TSAC4))")
                            .font(.caption)
                ...
                HStack
                    {
                    Text("\(typesBCodes[QuartzDB.Coat4PtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesB[QuartzDB.Coat4PtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSBC4))")
                        .font(.caption)
                }
                if QuartzDB.Coat4TSColorant != 0
                    {

                        HStack {
                            Text("\(TSColorantCodes[QuartzDB.Coat4TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[QuartzDB.Coat4TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
            ...
            else if QuartzDB.Coat4ProductType == 1
            {
                HStack
                {
                    Text("\(PCoatPtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[QuartzDB.Coat4PtA]) - \(hardeners[QuartzDB.Coat4PtB]), 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                        .font(.caption)
                ...
                HStack
                {
                    Text("\(PCoatHardenerCode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[QuartzDB.Coat4PtA]) Part B, 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                        .font(.caption)
            ...
            else if QuartzDB.Coat4ProductType == 2
            {
                ...
                HStack
                {
                    ...
                    if QuartzDB.Coat4PtA == 0
                    {
                    Text("\(PUTypes[QuartzDB.Coat4PtA]) - \(hardeners[QuartzDB.Coat4PtB]) Part A, 1 gal ")
                        .font(.caption)
                    }
                    // Poly HP Gloss
                    else if QuartzDB.Coat4PtA == 1
                    {
                    Text("\(PUTypes[QuartzDB.Coat4PtA]) Part A, 1/4 gal ")
                        .font(.caption)
                    }
                    // Poly HP Satin
                    else
                    {
                        Text("\(PUTypes[QuartzDB.Coat4PtA]) Part A, 1/2 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                ...
                HStack
                {
                    ...
                    if QuartzDB.Coat4PtA == 0
                    {
                    Text("\(PUTypes[QuartzDB.Coat4PtA]) Part B, 1/2 gal ")
                        .font(.caption)
                    }
                    else
                    {
                        Text("\(PUTypes[QuartzDB.Coat4PtA]) Part B, 1 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                ...
                // poly colorant
                if QuartzDB.Coat4PColorant != 0 && QuartzDB.Coat4ProductType != 0
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[QuartzDB.Coat4PColorant])")
                            .font(.caption)
                        Spacer()
                       
                        Text("Poly Colorant - \(PolyColorantChoices[QuartzDB.Coat4PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: quartzTS_TSColorantC4))")
                            .font(.caption)
                ...
                if QuartzDB.Coat4Texture != 0 {
                    if QuartzDB.Coat4Texture < 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[QuartzDB.Coat4Texture]), 10#")
                                .font(.caption)
                            Spacer()
                    ...
                    if QuartzDB.Coat4Texture >= 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[QuartzDB.Coat4Texture]), 32 oz")
                                .font(.caption)
                            Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $QuartzDB.Coat4Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: quartzTS_TSAC4) + QuartzDB.Coat4Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct QuartzDBTopCoat_Previews: PreviewProvider {
