    ...
    var body: some View {
        VStack {
           ...
           Text("Choose Your Speed:")
            .fontWeight(.bold)
            Picker(selection: $QuartzRC.PCoatPtB,
                label: ZStack {
                    Text("\(typesB[QuartzRC.PCoatPtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("UPC Colorant:")
             .fontWeight(.bold)
             Picker(selection: $QuartzRC.PCoatTSColorant,
                 label: ZStack {
                     Text("\(UPCColorantChoices[QuartzRC.PCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    Text("\(typesBCodes[QuartzRC.PCoatPtB])")
                        .font(.caption)
                    Spacer()
                ...
                {
                    HStack {
                        Text("\(UPCColorantCodes[QuartzRC.PCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("UPC Colorant - \(UPCColorantChoices[QuartzRC.PCoatTSColorant]), 4 oz")
                            .font(.caption)
                        Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $QuartzRC.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: UPC_QuartzRC) + QuartzRC.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatQuartzRC_Previews: PreviewProvider {
