    ...
    var body: some View {
        VStack {
           ...
           Text("Choose Your Speed:")
            .fontWeight(.bold)
            Picker(selection: $QuartzSL.BCoatPtB,
                label: ZStack {
                    Text("\(typesB[QuartzSL.BCoatPtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("UPC Colorant:")
             .fontWeight(.bold)
             Picker(selection: $QuartzSL.BCoatTSColorant,
                 label: ZStack {
                     Text("\(UPCColorantChoices[QuartzSL.BCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    Text("\(typesBCodes[QuartzSL.BCoatPtB])")
                        .font(.caption)
                    Spacer()
                ...
                {
                    HStack {
                        Text("\(UPCColorantCodes[QuartzSL.BCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("UPC Colorant - \(UPCColorantChoices[QuartzSL.BCoatTSColorant]), 4 oz")
                            .font(.caption)
                        Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $QuartzSL.BCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: UPC_QuartzSL) + QuartzSL.BCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct BCoatQuartzSL_Previews: PreviewProvider {
