...
var QuartzSL_TSAC4 = stats2(product: "Top Shelf® Epoxy Part A:", covRate: 210, MixRat: 1)
var QuartzSL_TSBC4 = stats2(product: "Top Shelf® Epoxy Part B:", covRate: 210, MixRat: 0.5)
var QuartzSL_TSColorantC4 = stats2(product: "Top Shelf® Epoxy Colorant:", covRate: 210, MixRat: 16)
...
struct ColorQuartzSLTopCoat: View {
    ...
    @EnvironmentObject var QuartzSL_TSAC4 : stats2
    @EnvironmentObject var QuartzSL_TSBC4 : stats2
    @EnvironmentObject var QuartzSL_TSColorantC4 : stats2
    ...
    func updateCovRate() -> Void
    {
        ...
        else if QuartzSL.Coat4ProductType == 1
        {
            QuartzSL_TSAC4.covRate = 750
            QuartzSL_TSBC4.covRate = 750
        }
        // else poly is chosen
        else
        {
            ...
            if QuartzSL.Coat4PtA == 0
            {
                QuartzSL_TSAC4.covRate = 560
                QuartzSL_TSBC4.covRate = 560
            }
            // HP clear gloss
            else if QuartzSL.Coat4PtA == 1
            {
                QuartzSL_TSAC4.covRate = 575
                QuartzSL_TSBC4.covRate = 575
            }

            // HP clear satin
            else
            {
                QuartzSL_TSAC4.covRate = 675
                QuartzSL_TSBC4.covRate = 675
            }
        }
    }
    ...
    func checkPCoatCodes() -> Void {
        ...
        if QuartzSL.Coat4PtA == 0 && QuartzSL.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY72AZ-01"
            PCoatHardenerCode = "EX-KPLY72B-01"
        }
        else if QuartzSL.Coat4PtA == 0 && QuartzSL.Coat4PtB == 1 {
            PCoatPtACode = "EX-KPLY72AF-01"
            PCoatHardenerCode = "EX-KPLY72B-01"
            
        }
        else if QuartzSL.Coat4PtA == 1 && QuartzSL.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY85AZ-01"
            PCoatHardenerCode = "EX-KPLY85B-01"
        }
        else if QuartzSL.Coat4PtA == 1 && QuartzSL.Coat4PtB == 1 {
            PCoatPtACode = "EX-KPLY85AF-01"
            PCoatHardenerCode = "EX-KPLY85B-01"
            
        }
        else if QuartzSL.Coat4PtA == 2 && QuartzSL.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY92AZ-01"
            PCoatHardenerCode = "EX-KPLY92B-01"
            
        }
        else if QuartzSL.Coat4PtA == 2 && QuartzSL.Coat4PtB == 1 {
    ...
    var body: some View {
        VStack {
            HStack {
                Text("Coat 4 Product:")
                    .fontWeight(.bold)
                Picker(selection: $QuartzSL.Coat4ProductType,
                       label: ZStack {
                    Text("\(products[QuartzSL.Coat4ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
 ...
 //               SplashTSFloorInfo()
            ...
            HStack {
                Toggle(isOn: $QuartzSL.Coat4MatAdd, label: {
            ...
            Text("Top Shelf Epoxy® Part A:")
                .fontWeight(.bold)
            Picker(selection: $QuartzSL.Coat4PtA,
                   label: ZStack {
                Text("\(typesA[QuartzSL.Coat4PtA])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            Text("Top Shelf Epoxy® Part B:")
                .fontWeight(.bold)
            Picker(selection: $QuartzSL.Coat4PtB,
                   label: ZStack {
                Text("\(typesB[QuartzSL.Coat4PtB])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            //             .onChange(of: QuartzSL.Coat4PtB) { _ in
            //                 CheckCoatChoices()
            //             }
            Text("Top Shelf Epoxy® Colorant:")
                .fontWeight(.bold)
            Picker(selection: $QuartzSL.Coat4TSColorant,
                   label: ZStack {
                Text("\(TSColorantChoices[QuartzSL.Coat4TSColorant])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            else if QuartzSL.Coat4ProductType == 1
            {
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                .onChange(of: QuartzSL.Coat4PtA) { _ in
                    checkPCoatCodes()
                }
                
                Picker(selection: $QuartzSL.Coat4PtB,
                       label: ZStack {
                    Text("\(hardeners[QuartzSL.Coat4PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            if QuartzSL.Coat4ProductType != 0
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $QuartzSL.Coat4PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[QuartzSL.Coat4PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            Text("Texture:")
                .fontWeight(.bold)
            Picker(selection: $QuartzSL.Coat4Texture,
                   label: ZStack {
                Text("\(TextureOptions[QuartzSL.Coat4Texture])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            .onChange(of: QuartzSL.Coat4Texture) { _ in
                checkTexture()
            }
            ...
            VStack { // Start of coat summary
                ...
                if QuartzSL.Coat4ProductType == 0
                {
                if QuartzSL.Coat4PtA == 4 {
                    HStack{
                        Text("\(typesACodes[QuartzSL.Coat4PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: Ench. Green, 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: QuartzSL_TSAC4))")
                            .font(.caption)
                    }
                }
                else {
                    HStack{
                        Text("\(typesACodes[QuartzSL.Coat4PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: \(typesA[QuartzSL.Coat4PtA]), 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: QuartzSL_TSAC4))")
                            .font(.caption)
                ...
                HStack
                    {
                    Text("\(typesBCodes[QuartzSL.Coat4PtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesB[QuartzSL.Coat4PtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: QuartzSL_TSBC4))")
                        .font(.caption)
                }
                if QuartzSL.Coat4TSColorant != 0
                    {

                        HStack {
                            Text("\(TSColorantCodes[QuartzSL.Coat4TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[QuartzSL.Coat4TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: QuartzSL_TSColorantC4))")
                                .font(.caption)
                        }
            ...
            else if QuartzSL.Coat4ProductType == 1
            {
                HStack
                {
                    Text("\(PCoatPtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[QuartzSL.Coat4PtA]) - \(hardeners[QuartzSL.Coat4PtB]), 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: QuartzSL_TSAC4))")
                        .font(.caption)
                ...
                HStack
                {
                    Text("\(PCoatHardenerCode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[QuartzSL.Coat4PtA]) Part B, 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: QuartzSL_TSAC4))")
                        .font(.caption)
            ...
            else if QuartzSL.Coat4ProductType == 2
            {
                ...
                HStack
                {
                    ...
                    if QuartzSL.Coat4PtA == 0
                    {
                    Text("\(PUTypes[QuartzSL.Coat4PtA]) - \(hardeners[QuartzSL.Coat4PtB]) Part A, 1 gal ")
                        .font(.caption)
                    }
                    // Poly HP Gloss
                    else if QuartzSL.Coat4PtA == 1
                    {
                    Text("\(PUTypes[QuartzSL.Coat4PtA]) Part A, 1/4 gal ")
                        .font(.caption)
                    }
                    // Poly HP Satin
                    else
                    {
                        Text("\(PUTypes[QuartzSL.Coat4PtA]) Part A, 1/2 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: QuartzSL_TSAC4))")
                ...
                HStack
                {
                    ...
                    if QuartzSL.Coat4PtA == 0
                    {
                    Text("\(PUTypes[QuartzSL.Coat4PtA]) Part B, 1/2 gal ")
                        .font(.caption)
                    }
                    else
                    {
                        Text("\(PUTypes[QuartzSL.Coat4PtA]) Part B, 1 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: QuartzSL_TSAC4))")
                ...
                // poly colorant
                if QuartzSL.Coat4PColorant != 0 && QuartzSL.Coat4ProductType != 0
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[QuartzSL.Coat4PColorant])")
                            .font(.caption)
                        Spacer()
                       
                        Text("Poly Colorant - \(PolyColorantChoices[QuartzSL.Coat4PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: QuartzSL_TSColorantC4))")
                            .font(.caption)
                ...
                if QuartzSL.Coat4Texture != 0 {
                    if QuartzSL.Coat4Texture < 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[QuartzSL.Coat4Texture]), 10#")
                                .font(.caption)
                            Spacer()
                    ...
                    if QuartzSL.Coat4Texture >= 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[QuartzSL.Coat4Texture]), 32 oz")
                                .font(.caption)
                            Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $QuartzSL.Coat4Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: QuartzSL_TSAC4) + QuartzSL.Coat4Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct QuartzSLTopCoat_Previews: PreviewProvider {
