    ...
    var body: some View {
        VStack {
           ...
           Text("Choose Your Speed:")
            .fontWeight(.bold)
            Picker(selection: $QuartzTT.PCoatPtB,
                label: ZStack {
                    Text("\(typesB[QuartzTT.PCoatPtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("UPC Colorant:")
             .fontWeight(.bold)
             Picker(selection: $QuartzTT.PCoatTSColorant,
                 label: ZStack {
                     Text("\(UPCColorantChoices[QuartzTT.PCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    Text("\(typesBCodes[QuartzTT.PCoatPtB])")
                        .font(.caption)
                    Spacer()
                ...
                {
                    HStack {
                        Text("\(UPCColorantCodes[QuartzTT.PCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("UPC Colorant - \(UPCColorantChoices[QuartzTT.PCoatTSColorant]), 4 oz")
                            .font(.caption)
                        Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $QuartzTT.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: UPC_QuartzTT) + QuartzTT.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatQuartzTT_Previews: PreviewProvider {
