...
struct ColorQuartzSGCapCoat: View {
...
//            if quartzSG.Coat3PtA == 0
//            {
//                TSAC3.covRate = 600
//                TSBC3.covRate = 600
//            }
//            // HP clear gloss
//            else if quartzSG.Coat3PtA == 1
//            {
//                TSAC3.covRate = 575
//                TSBC3.covRate = 575
//            }
...
//            }
    ...
    func checkPCoatCodes() -> Void {
        ...
        if quartzSG.Coat3PtA == 0 && quartzSG.Coat3PtB == 0 {
            quartzSG.PCoatPtACode = "EX-KPLY72AZ-01"
            quartzSG.PCoatHardenerCode = "EX-KPLY72B-01"
        }
        else if quartzSG.Coat3PtA == 0 && quartzSG.Coat3PtB == 1 {
            quartzSG.PCoatPtACode = "EX-KPLY72AF-01"
            quartzSG.PCoatHardenerCode = "EX-KPLY72B-01"
            
        }
        else if quartzSG.Coat3PtA == 1 && quartzSG.Coat3PtB == 0 {
            quartzSG.PCoatPtACode = "EX-KPLY85AZ-01"
            quartzSG.PCoatHardenerCode = "EX-KPLY85B-01"
        }
        else if quartzSG.Coat3PtA == 1 && quartzSG.Coat3PtB == 1 {
            quartzSG.PCoatPtACode = "EX-KPLY85AF-01"
            quartzSG.PCoatHardenerCode = "EX-KPLY85B-01"
            
        }
        else if quartzSG.Coat3PtA == 2 && quartzSG.Coat3PtB == 0 {
            quartzSG.PCoatPtACode = "EX-KPLY92AZ-01"
            quartzSG.PCoatHardenerCode = "EX-KPLY92B-01"
            
        }
        else if quartzSG.Coat3PtA == 2 && quartzSG.Coat3PtB == 1 {
            quartzSG.PCoatPtACode = "EX-KPLY92AF-01"
            quartzSG.PCoatHardenerCode = "EX-KPLY92B-01"
    ...
    func checkPUCodes() -> Void
    {
        // POLY HS EZ
        if quartzSG.Coat3PtA == 0 && quartzSG.Coat3PtB == 0 {
            quartzSG.PUPtACode = "EX-KPLYHSAZ-01"
            quartzSG.PUHardenerCode = "EX-KPLYHSB-01"
        }
        // POLY HS FAST
        else if quartzSG.Coat3PtA == 0 && quartzSG.Coat3PtB == 1 {
            quartzSG.PUPtACode = "EX-KPLYHSAF-01"
            quartzSG.PUHardenerCode = "EX-KPLYHSB-01"
        ...
        VStack {
            HStack {
                Text("Cap Coat Product:")
                    .fontWeight(.bold)
                Picker(selection: $quartzSG.Coat3ProductType,
                       label: ZStack {
                    Text("\(products[quartzSG.Coat3ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
 ...
 //               SplashTSFloorInfo()
            ...
            HStack {
                Toggle(isOn: $quartzSG.Coat3MatAdd, label: {
            ...
            Text("Top Shelf Epoxy® Part A:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat3PtA,
                   label: ZStack {
                Text("\(typesA[quartzSG.Coat3PtA])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            Text("Top Shelf Epoxy® Part B:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat3PtB,
                   label: ZStack {
                Text("\(typesB[quartzSG.Coat3PtB])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            //             .onChange(of: quartzSG.Coat3PtB) { _ in
            //                 CheckCoatChoices()
            //             }
            Text("Top Shelf Epoxy® Colorant:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat3TSColorant,
                   label: ZStack {
                Text("\(TSColorantChoices[quartzSG.Coat3TSColorant])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            else if quartzSG.Coat3ProductType == 1
            {
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                .onChange(of: quartzSG.Coat3PtA) { _ in
                    checkPCoatCodes()
                }
                
                Picker(selection: $quartzSG.Coat3PtB,
                       label: ZStack {
                    Text("\(hardeners[quartzSG.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            if quartzSG.Coat3ProductType != 0
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $quartzSG.Coat3PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[quartzSG.Coat3PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
...
//            Text("Texture:")
//                .fontWeight(.bold)
//            Picker(selection: $quartzSG.Coat3Texture,
//                   label: ZStack {
//                Text("\(TextureOptions[quartzSG.Coat3Texture])")
//                    .opacity(1)
//                Rectangle()
//                    .fill(Color.black)
//                    .opacity(0.9)
...
//            .background(Color.gray.opacity(0.2))
//            .cornerRadius(5)
//            .onChange(of: quartzSG.Coat3Texture) { _ in
//                checkTexture()
//            }
            ...
            VStack { // Start of coat summary
                ...
                if quartzSG.Coat3PtA == 4 {
                    HStack{
                        Text("\(typesACodes[quartzSG.Coat3PtA])")
                            .font(.caption)
                        Spacer()
                    ...
                    HStack{
                        Text("\(typesACodes[quartzSG.Coat3PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: \(typesA[quartzSG.Coat3PtA]), 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: quartzTS_TSAC3))")
                            .font(.caption)
                ...
                HStack{
                    Text("\(typesBCodes[quartzSG.Coat3PtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesB[quartzSG.Coat3PtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSBC3))")
                        .font(.caption)
                }
                if quartzSG.Coat3TSColorant != 0 {

                        HStack {
                            Text("\(TSColorantCodes[quartzSG.Coat3TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[quartzSG.Coat3TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
            ...
            else if quartzSG.Coat3ProductType == 1
            {
                HStack
                {
                    Text("\(PCoatPtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[quartzSG.Coat3PtA]) - \(hardeners[quartzSG.Coat3PtB]), 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC3))")
                        .font(.caption)
                ...
                HStack
                {
                    Text("\(PCoatHardenerCode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[quartzSG.Coat3PtA]) Part B, 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC3))")
                        .font(.caption)
            ...
            else
            {
                ...
                HStack
                {
                    ...
                    if quartzSG.Coat3PtA == 0
                    {
                    Text("\(PUTypes[quartzSG.Coat3PtA]) - \(hardeners[quartzSG.Coat3PtB]) Part A, 1 gal ")
                        .font(.caption)
                    }
                    // Poly HP Gloss
                    else if quartzSG.Coat3PtA == 1
                    {
                    Text("\(PUTypes[quartzSG.Coat3PtA]) Part A, 1/4 gal ")
                        .font(.caption)
                    }
                    // Poly HP Satin
                    else
                    {
                        Text("\(PUTypes[quartzSG.Coat3PtA]) Part A, 1/2 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC3))")
                ...
                HStack
                {
                    ...
                    if quartzSG.Coat3PtA == 0
                    {
                    Text("\(PUTypes[quartzSG.Coat3PtA]) Part B, 1/2 gal ")
                        .font(.caption)
                    }
                    else
                    {
                        Text("\(PUTypes[quartzSG.Coat3PtA]) Part B, 1 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC3))")
                ...
                // poly colorant
                if quartzSG.Coat3PColorant != 0 && quartzSG.Coat3ProductType != 0
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[quartzSG.Coat3PColorant])")
                            .font(.caption)
                        Spacer()
                       
                        Text("Poly Colorant - \(PolyColorantChoices[quartzSG.Coat3PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: quartzTS_TSColorantC3))")
                            .font(.caption)
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $quartzSG.Coat3Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: quartzTS_TSAC3) + quartzSG.Coat3Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct QuartzSGCoat3_Previews: PreviewProvider {
