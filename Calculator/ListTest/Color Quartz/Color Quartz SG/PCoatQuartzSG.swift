...
struct PCoatQuartzSG: View {
    ...
    @EnvironmentObject var TSColorant_SG : stats //Used for system stats (mixRat,CovRate, etc)
    ...
    var body: some View {
        VStack {
           ...
           Text("Top Shelf Epoxy® Part A:")
            .fontWeight(.bold)
            Picker(selection: $QuartzSG.PCoatPtA,
                label: ZStack {
                    Text("\(typesA[QuartzSG.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("Top Shelf Epoxy® Part B:")
             .fontWeight(.bold)
             Picker(selection: $QuartzSG.PCoatPtB,
                 label: ZStack {
                     Text("\(typesB[QuartzSG.PCoatPtB])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
             ...
             .background(Color.gray.opacity(0.2))
             .cornerRadius(5)
//             .onChange(of: QuartzSG.PCoatPtB) { _ in
//                quant(product: TSB)
//             }
            Text("Top Shelf Epoxy® Colorant:")
             .fontWeight(.bold)
             Picker(selection: $QuartzSG.PCoatTSColorant,
                 label: ZStack {
                     Text("\(TSColorantChoices[QuartzSG.PCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
            ...
            VStack { // Start of coat summary
                HStack {
                    ...
                    HStack{
                        ...
                        Text("TSE Part A: \(typesA[QuartzSG.PCoatPtA]), 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSA_QuartzSG))")
                            .font(.caption)
                    }
                ...
                HStack{
                    ...
                    Text("Top Shelf® Epoxy Part B: \(typesB[QuartzSG.PCoatPtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSB_QuartzSG))")
                        .font(.caption)
                }
                ...
                if QuartzSG.PCoatTSColorant != 0
                {
                    HStack {
                        Text("\(TSColorantCodes[QuartzSG.BCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[QuartzSG.PCoatTSColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSColorant_QuartzSG))")
                            .font(.caption)
                    }
                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $QuartzSG.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSA_QuartzSG) + QuartzSG.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatQuartzSG_Previews: PreviewProvider {
