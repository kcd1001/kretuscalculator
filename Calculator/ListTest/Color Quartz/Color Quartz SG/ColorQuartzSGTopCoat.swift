...
struct ColorQuartzSGTopCoat: View {
    ...
    func updateCovRate() -> Void
    {
        ...
        else if quartzSG.Coat4ProductType == 1
        {
    ...
    func checkPCoatCodes() -> Void {
        ...
        if quartzSG.Coat4PtA == 0 && quartzSG.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY72AZ-01"
            PCoatHardenerCode = "EX-KPLY72B-01"
        }
        else if quartzSG.Coat4PtA == 0 && quartzSG.Coat4PtB == 1 {
            PCoatPtACode = "EX-KPLY72AF-01"
            PCoatHardenerCode = "EX-KPLY72B-01"
            
        }
        else if quartzSG.Coat4PtA == 1 && quartzSG.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY85AZ-01"
            PCoatHardenerCode = "EX-KPLY85B-01"
        }
        else if quartzSG.Coat4PtA == 1 && quartzSG.Coat4PtB == 1 {
            PCoatPtACode = "EX-KPLY85AF-01"
            PCoatHardenerCode = "EX-KPLY85B-01"
            
        }
        else if quartzSG.Coat4PtA == 2 && quartzSG.Coat4PtB == 0 {
            PCoatPtACode = "EX-KPLY92AZ-01"
            PCoatHardenerCode = "EX-KPLY92B-01"
            
        }
        else if quartzSG.Coat4PtA == 2 && quartzSG.Coat4PtB == 1 {
        ...
        VStack {
            HStack {
                Text("Top Coat Product:")
                    .fontWeight(.bold)
                Picker(selection: $quartzSG.Coat4ProductType,
                       label: ZStack {
                    Text("\(products[quartzSG.Coat4ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
 ...
 //               SplashTSFloorInfo()
            ...
            HStack {
                Toggle(isOn: $quartzSG.Coat4MatAdd, label: {
            ...
            Text("Top Shelf Epoxy® Part A:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat4PtA,
                   label: ZStack {
                Text("\(typesA[quartzSG.Coat4PtA])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            Text("Top Shelf Epoxy® Part B:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat4PtB,
                   label: ZStack {
                Text("\(typesB[quartzSG.Coat4PtB])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            //             .onChange(of: quartzSG.Coat4PtB) { _ in
            //                 CheckCoatChoices()
            //             }
            Text("Top Shelf Epoxy® Colorant:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat4TSColorant,
                   label: ZStack {
                Text("\(TSColorantChoices[quartzSG.Coat4TSColorant])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            else if quartzSG.Coat4ProductType == 1
            {
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                .onChange(of: quartzSG.Coat4PtA) { _ in
                    checkPCoatCodes()
                }
                
                Picker(selection: $quartzSG.Coat4PtB,
                       label: ZStack {
                    Text("\(hardeners[quartzSG.Coat4PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            if quartzSG.Coat4ProductType != 0
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $quartzSG.Coat4PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[quartzSG.Coat4PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            Text("Texture:")
                .fontWeight(.bold)
            Picker(selection: $quartzSG.Coat4Texture,
                   label: ZStack {
                Text("\(TextureOptions[quartzSG.Coat4Texture])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            .onChange(of: quartzSG.Coat4Texture) { _ in
                checkTexture()
            }
            ...
            VStack { // Start of coat summary
                ...
                if quartzSG.Coat4ProductType == 0
                {
                if quartzSG.Coat4PtA == 4 {
                    HStack{
                        Text("\(typesACodes[quartzSG.Coat4PtA])")
                            .font(.caption)
                        Spacer()
                    ...
                    HStack{
                        Text("\(typesACodes[quartzSG.Coat4PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: \(typesA[quartzSG.Coat4PtA]), 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: quartzTS_TSAC4))")
                            .font(.caption)
                ...
                HStack
                    {
                    Text("\(typesBCodes[quartzSG.Coat4PtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesB[quartzSG.Coat4PtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSBC4))")
                        .font(.caption)
                }
                if quartzSG.Coat4TSColorant != 0
                    {

                        HStack {
                            Text("\(TSColorantCodes[quartzSG.Coat4TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[quartzSG.Coat4TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
            ...
            else if quartzSG.Coat4ProductType == 1
            {
                HStack
                {
                    Text("\(PCoatPtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[quartzSG.Coat4PtA]) - \(hardeners[quartzSG.Coat4PtB]), 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                        .font(.caption)
                ...
                HStack
                {
                    Text("\(PCoatHardenerCode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[quartzSG.Coat4PtA]) Part B, 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                        .font(.caption)
            ...
            else if quartzSG.Coat4ProductType == 2
            {
                ...
                HStack
                {
                    ...
                    if quartzSG.Coat4PtA == 0
                    {
                    Text("\(PUTypes[quartzSG.Coat4PtA]) - \(hardeners[quartzSG.Coat4PtB]) Part A, 1 gal ")
                        .font(.caption)
                    }
                    // Poly HP Gloss
                    else if quartzSG.Coat4PtA == 1
                    {
                    Text("\(PUTypes[quartzSG.Coat4PtA]) Part A, 1/4 gal ")
                        .font(.caption)
                    }
                    // Poly HP Satin
                    else
                    {
                        Text("\(PUTypes[quartzSG.Coat4PtA]) Part A, 1/2 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                ...
                HStack
                {
                    ...
                    if quartzSG.Coat4PtA == 0
                    {
                    Text("\(PUTypes[quartzSG.Coat4PtA]) Part B, 1/2 gal ")
                        .font(.caption)
                    }
                    else
                    {
                        Text("\(PUTypes[quartzSG.Coat4PtA]) Part B, 1 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: quartzTS_TSAC4))")
                ...
                // poly colorant
                if quartzSG.Coat4PColorant != 0 && quartzSG.Coat4ProductType != 0
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[quartzSG.Coat4PColorant])")
                            .font(.caption)
                        Spacer()
                       
                        Text("Poly Colorant - \(PolyColorantChoices[quartzSG.Coat4PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: quartzTS_TSColorantC4))")
                            .font(.caption)
                ...
                if quartzSG.Coat4Texture != 0 {
                    if quartzSG.Coat4Texture < 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[quartzSG.Coat4Texture]), 10#")
                                .font(.caption)
                            Spacer()
                    ...
                    if quartzSG.Coat4Texture >= 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[quartzSG.Coat4Texture]), 32 oz")
                                .font(.caption)
                            Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $quartzSG.Coat4Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: quartzTS_TSAC4) + quartzSG.Coat4Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct QuartzSGTopCoat_Previews: PreviewProvider {
