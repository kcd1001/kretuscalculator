...
var SandSL_TSAC3 = stats2(product: "Top Shelf® Epoxy Part A:", covRate: 120, MixRat: 1)
var SandSL_TSBC3 = stats2(product: "Top Shelf® Epoxy Part B:", covRate: 120, MixRat: 0.5)
var SandSL_TSColorantC3 = stats2(product: "Top Shelf® Epoxy Colorant:", covRate: 120, MixRat: 16)

struct IndustrialSandSLCapCoat: View {
    ...
    ////            if SandSL.Coat3PtA == 0
    ////            {
    ////                TSAC3.covRate = 600
    ////                TSBC3.covRate = 600
    ////            }
    ////            // HP clear gloss
    ////            else if SandSL.Coat3PtA == 1
    ////            {
    ////                TSAC3.covRate = 575
    ////                TSBC3.covRate = 575
    ////            }
    ...
    var body: some View {
        VStack {
            HStack {
                Text("Coat 3 Product:")
                    .fontWeight(.bold)
                Picker(selection: $SandSL.Coat3ProductType,
                       label: ZStack {
                    Text("\(products[SandSL.Coat3ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            HStack {
                Toggle(isOn: $SandSL.Coat3MatAdd, label: {
            ...
            if SandSL.Coat3ProductType == 0
            {
                Text("Top Shelf Epoxy® Part A:")
                    .fontWeight(.bold)
                Picker(selection: $SandSL.Coat3PtA,
                       label: ZStack {
                    Text("\(typesA[SandSL.Coat3PtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
                ...
                Text("Top Shelf Epoxy® Part B:")
                    .fontWeight(.bold)
                Picker(selection: $SandSL.Coat3PtB,
                       label: ZStack {
                    Text("\(typesB[SandSL.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                //             .onChange(of: SandSL.Coat3PtB) { _ in
                //                 CheckCoatChoices()
                //             }
                Text("Top Shelf Epoxy® Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $SandSL.Coat3TSColorant,
                       label: ZStack {
                    Text("\(TSColorantChoices[SandSL.Coat3TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            else if SandSL.Coat3ProductType == 1
            {
                HStack
                {
                    ...
                    .background(Color.gray.opacity(0.2))
                    .cornerRadius(5)
                    .onChange(of: SandSL.Coat3PtA) { _ in
                        checkPCoatCodes()
                    }
                    
                    Picker(selection: $SandSL.Coat3PtB,
                           label: ZStack {
                        Text("\(hardeners[SandSL.Coat3PtB])")
                            .opacity(1)
                        Rectangle()
                            .fill(Color.black)
                            .opacity(0.9)
            ...
            else
            {
                ...
                HStack
                {
                    ...
                    Picker(selection: $SandSL.Coat3TSColorant,
                           label: ZStack {
                        Text("\(UPCColorantChoices[SandSL.Coat3TSColorant])")
                            .opacity(1)
                        Rectangle()
                            .fill(Color.gray)
                            .opacity(0.2)
            ...
            if SandSL.Coat3ProductType != 0 && SandSL.Coat3ProductType != 3
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $SandSL.Coat3PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[SandSL.Coat3PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            //            Text("Texture:")
            //                .fontWeight(.bold)
            //            Picker(selection: $SandSL.Coat3Texture,
            //                   label: ZStack {
            //                Text("\(TextureOptions[SandSL.Coat3Texture])")
            //                    .opacity(1)
            //                Rectangle()
            //                    .fill(Color.black)
            //                    .opacity(0.9)
            ...
            //            .background(Color.gray.opacity(0.2))
            //            .cornerRadius(5)
            //            .onChange(of: SandSL.Coat3Texture) { _ in
            //                checkTexture()
            //            }
            ...
            VStack { // Start of coat summary
                ...
                if SandSL.Coat3ProductType == 0
                {
                    ...
                    if SandSL.Coat3PtA == 4 {
                        HStack{
                            Text("\(typesACodes[SandSL.Coat3PtA])")
                                .font(.caption)
                            Spacer()
                            Text("TSE Part A: Ench. Green, 1 gal")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandSL_TSAC3))")
                                .font(.caption)
                        }
                    }
                    else {
                        HStack{
                            Text("\(typesACodes[SandSL.Coat3PtA])")
                                .font(.caption)
                            Spacer()
                            Text("TSE Part A: \(typesA[SandSL.Coat3PtA]), 1 gal")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandSL_TSAC3))")
                                .font(.caption)
                    ...
                    HStack{
                        Text("\(typesBCodes[SandSL.Coat3PtB])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Part B: \(typesB[SandSL.Coat3PtB]), 1/2 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandSL_TSAC3))")
                            .font(.caption)
                    }
                    if SandSL.Coat3TSColorant != 0 {
                        
                        HStack {
                            Text("\(TSColorantCodes[SandSL.Coat3TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandSL.Coat3TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandSL_TSColorantC3))")
                                .font(.caption)
                        }
                ...
                else if SandSL.Coat3ProductType == 1
                {
                    HStack
                    {
                        Text("\(PCoatPtACode)")
                            .font(.caption)
                        Spacer()
                        Text("\(PATypes[SandSL.Coat3PtA]) - \(hardeners[SandSL.Coat3PtB]), 1 gal ")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandSL_TSAC3))")
                            .font(.caption)
                    ...
                    HStack
                    {
                        Text("\(PCoatHardenerCode)")
                            .font(.caption)
                        Spacer()
                        Text("\(PATypes[SandSL.Coat3PtA]) Part B, 1 gal ")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandSL_TSAC3))")
                            .font(.caption)
                ...
                else if SandSL.Coat3ProductType == 2
                {
                    ...
                    HStack
                    {
                        ...
                        if SandSL.Coat3PtA == 0
                        {
                            Text("\(PUTypes[SandSL.Coat3PtA]) - \(hardeners[SandSL.Coat3PtB]) Part A, 1 gal ")
                                .font(.caption)
                        }
                        // Poly HP Gloss
                        else if SandSL.Coat3PtA == 1
                        {
                            Text("\(PUTypes[SandSL.Coat3PtA]) Part A, 1/4 gal ")
                                .font(.caption)
                        }
                        // Poly HP Satin
                        else
                        {
                            Text("\(PUTypes[SandSL.Coat3PtA]) Part A, 1/2 gal ")
                                .font(.caption)
                        }
                        Spacer()
                        Text("\(quant(product: SandSL_TSAC3))")
                    ...
                    HStack
                    {
                        ...
                        if SandSL.Coat3PtA == 0
                        {
                            Text("\(PUTypes[SandSL.Coat3PtA]) Part B, 1/2 gal ")
                                .font(.caption)
                        }
                        else
                        {
                            Text("\(PUTypes[SandSL.Coat3PtA]) Part B, 1 gal ")
                                .font(.caption)
                        }
                        Spacer()
                        Text("\(quant(product: SandSL_TSAC3))")
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        HStack
                        {
                            Text("EX-BRCUVAP6-EA")
                                .font(.caption)
                            Spacer()
                            Text("UPC Part B - \(Text("\(typesB[SandSL.Coat3PtB])") ), 6#")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandSL_TSAC3 ))")
                                .font(.caption)
                    ...
                    if SandSL.Coat3TSColorant != 0
                    {
                        HStack
                        {
                            Text("\(UPCColorantCodes[SandSL.Coat3TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("UPC Colorant - \(UPCColorantChoices[SandSL.Coat3TSColorant]), 4 oz")
                                .font(.caption)
                            Spacer()
                ...
                // poly colorant
                if SandSL.Coat3PColorant != 0 && (SandSL.Coat3ProductType != 0 || SandSL.Coat3ProductType != 3)
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[SandSL.Coat3PColorant])")
                            .font(.caption)
                        Spacer()
                        
                        Text("Poly Colorant - \(PolyColorantChoices[SandSL.Coat3PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandSL_TSColorantC3))")
                            .font(.caption)
        ...
        HStack {
            ...
            Spacer()
            TextField("",value: $SandSL.Coat3Waste, formatter: NumberFormatter())
        ...
        HStack {
            Text("Total:")
            Spacer()
            Text("\(quant(product: SandSL_TSAC3) + SandSL.Coat3Waste) kit(s)")
        }
        .padding()
    }
}
...
struct IndustrialSandSLCoat3_Previews: PreviewProvider {
