...
struct IndustrialSandSLSysSummary: View {
    ...
    @EnvironmentObject var bCoatCoveSandSLA : stats2
    @EnvironmentObject var bCoatCoveSandSLB : stats2
    @EnvironmentObject var bCoatCoveSandSLColorant : stats2
    @EnvironmentObject var bCoatCoveQuartzTexture : stats2
    @EnvironmentObject var BroadcastSandSL : statsBroadcast

    
//    var BroadcastSandSL = statsBroadcast(product: "Color Quartz", covRate: 0.25, MixRat: 50)
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    ...
                    Text("UPC Part A - RC/TT, 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSA_SandSL) + SandSL.PCoatWaste)")
                        .font(.caption)
                }
                
                HStack{
                    Text("\(upcTypesBCodes[SandSL.PCoatPtB])")
                        .font(.caption)
                    Spacer()
                    Text("UPC Part B - RC/TT \(upcTypesB[SandSL.PCoatPtB]), 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSB_SandSL) + SandSL.PCoatWaste)")
                        .font(.caption)
                }
                ...
                if SandSL.PCoatTSColorant != 0
                {
                    HStack {
                        Text("\(UPCColorantCodes[SandSL.PCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("UPC Colorant:  \(UPCColorantChoices[SandSL.PCoatTSColorant]), 4 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSColorant_SandSL) + SandSL.PCoatWaste)")
                            .font(.caption)
                    }
                }
        ...
        VStack { // Start of coat summary
            ...
            HStack{
                ...
                Text("UPC Part A - SL/MF, 8#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSABC_SandSL) + SandSL.BCoatWaste)")
                    .font(.caption)
            }
            
            HStack{
                Text("\(upcTypesBCodes[SandSL.BCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("UPC Part B - SL/MF \(upcTypesB[SandSL.BCoatPtB]), 8#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSBBC_SandSL) + SandSL.BCoatWaste)")
                    .font(.caption)
            }
            ...
            if SandSL.BCoatTSColorant != 0
            {
                HStack {
                    ...
                    Text("UPC Colorant:  \(UPCColorantChoices[SandSL.BCoatTSColorant]), 4 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSColorantBC_SandSL) + SandSL.BCoatWaste)")
                        .font(.caption)
                }
            }
        ...
        VStack { // Start of coat summary
            ...
            HStack {
                ...
                Text("Kretus® Approved \(ChipSizes[SandSL.BroadcastSizeSelection]) Industrial Sand")
                    .font(.caption)
                Spacer()
                Text("\(quantBroadcast(product: BroadcastSandSL) + SandSL.BroadcastWaste)")
                    .font(.caption)
            }
        }
        .background(Color(red:239.0/255.0, green: 243.0/255.0, blue: 244.0/250, opacity: 1.0))
    ...
    struct IndustrialSandSLSysSummary_Previews: PreviewProvider {
