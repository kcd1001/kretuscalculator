...
//    var BroadcastQuartzTS = stats(product: "Color Chip:", covRate: 0.15, MixRat: 55)
    ...
    func updateCovRate() -> Void
    {
        ...
        if SandDBRC.BroadcastSizeSelection == 0
        {
            ...
            TSABC2_SandDBRC.covRate = 100
            TSBBC2_SandDBRC.covRate = 100
            TSColorantBC2_SandDBRC.covRate = 100
            
        }
        else if SandDBRC.BroadcastSizeSelection == 1
        {
            TSABC_SandDBRC.covRate = 190
            TSBBC_SandDBRC.covRate = 190
            TSColorantBC_SandDBRC.covRate = 190
            
            TSABC2_SandDBRC.covRate = 150
            TSBBC2_SandDBRC.covRate = 150
            TSColorantBC2_SandDBRC.covRate = 150
    ...
    var body: some View {
        VStack {
            HStack {
             ...
             .fontWeight(.bold)
             Picker(selection: $SandDBRC.BroadcastSizeSelection, //used for size of chips
                 label: ZStack {
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandDBRC.BroadcastWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quantBroadcast(product: BroadcastSandDBRC) + SandDBRC.BroadcastWaste) bag(s)")
            }
            .padding()
        }
    }
...
struct BroadcastSandDBRC_Previews: PreviewProvider {
