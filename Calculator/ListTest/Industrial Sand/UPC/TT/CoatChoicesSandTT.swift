    ...
    var body: some View {
        ...
        if showingPicker == true && Chip.isPrimeCoat == true {  // Base coat + prime coat
            ...
            if showingPCoat == true {
                PCoatIndustrialSandTT()
                    .environmentObject(TSA_SandTT)
                    .environmentObject(TSB_SandTT)
            }
        }
        ...
        if showingPicker == true { // Only base coat selected
            ...
            if showingBCoat == true {
                BCoatIndustrialSandTT()
                    .environmentObject(TSABC_SandTT)
                    .environmentObject(TSBBC_SandTT)
                    .environmentObject(TSColorantBC_SandTT)
            }
            ...
            if showingBroadcast == true {
                BroadcastSandTT()
                    .environmentObject(SandTT_TSAC3)
                    .environmentObject(SandTT_TSBC3)
                    .environmentObject(SandTT_TSColorantC3)
                    .environmentObject(TSABC_SandTT)
                    .environmentObject(TSBBC_SandTT)
                    .environmentObject(TSColorantBC_SandTT)
...
//                    .environmentObject(PAPUTC1)
//                    .environmentObject(PAPUTC2)
                    .environmentObject(SandTT_TSAC4)
                    .environmentObject(SandTT_TSBC4)
                    .environmentObject(SandTT_TSColorantC4)
            }
...
struct CoatChoicesSandTT_Previews: PreviewProvider {
