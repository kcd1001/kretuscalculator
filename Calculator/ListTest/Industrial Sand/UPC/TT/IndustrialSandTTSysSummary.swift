...
struct IndustrialSandTTSysSummary: View {
    ...
    @EnvironmentObject var bCoatCoveSandTTA : stats2
    @EnvironmentObject var bCoatCoveSandTTB : stats2
    @EnvironmentObject var bCoatCoveSandTTColorant : stats2
    @EnvironmentObject var bCoatCoveQuartzTexture : stats2
    
    var BroadcastSandTT = statsBroadcast(product: "Color Quartz", covRate: 0.25, MixRat: 50)
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    ...
                    Text("UPC Part A - RC/TT, 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSA_SandTT) + SandTT.PCoatWaste)")
                        .font(.caption)
                }
                
                HStack{
                    Text("\(upcTypesBCodes[SandTT.PCoatPtB])")
                        .font(.caption)
                    Spacer()
                    Text("UPC Part B - RC/TT \(upcTypesB[SandTT.PCoatPtB]), 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSB_SandTT) + SandTT.PCoatWaste)")
                        .font(.caption)
                }
                ...
                if SandTT.PCoatTSColorant != 0
                {
                    HStack {
                        Text("\(UPCColorantCodes[SandTT.PCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("UPC Colorant:  \(UPCColorantChoices[SandTT.PCoatTSColorant]), 4 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSColorant_SandTT) + SandTT.PCoatWaste)")
                            .font(.caption)
                    }
                }
        ...
        VStack { // Start of coat summary
            ...
            HStack{
                ...
                Text("UPC Part A - RC/TT, 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSA_SandTT) + SandTT.BCoatWaste)")
                    .font(.caption)
            }
            
            HStack{
                Text("\(upcTypesBCodes[SandTT.BCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("UPC Part B - RC/TT \(upcTypesB[SandTT.BCoatPtB]), 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSB_SandTT) + SandTT.BCoatWaste)")
                    .font(.caption)
            }
            ...
            if SandTT.BCoatTSColorant != 0
            {
                HStack {
                    ...
                    Text("UPC Colorant:  \(UPCColorantChoices[SandTT.BCoatTSColorant]), 4 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSColorant_SandTT) + SandTT.BCoatWaste)")
                        .font(.caption)
                }
            }
        ...
        VStack { // Start of coat summary
            ...
            HStack {
                ...
                Text("Kretus® Approved Industrial Sand")
                    .font(.caption)
                Spacer()
                Text("\(quantBroadcast(product: BroadcastSandTT) + SandTT.BroadcastWaste)")
                    .font(.caption)
            }
        }
        .background(Color(red:239.0/255.0, green: 243.0/255.0, blue: 244.0/250, opacity: 1.0))
    ...
    struct IndustrialSandTTSysSummary_Previews: PreviewProvider {
