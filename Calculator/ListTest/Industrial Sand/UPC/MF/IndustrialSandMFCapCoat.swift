...
var SandMF_TSAC3 = stats2(product: "Top Shelf® Epoxy Part A:", covRate: 120, MixRat: 1)
var SandMF_TSBC3 = stats2(product: "Top Shelf® Epoxy Part B:", covRate: 120, MixRat: 0.5)
var SandMF_TSColorantC3 = stats2(product: "Top Shelf® Epoxy Colorant:", covRate: 120, MixRat: 16)

struct IndustrialSandMFCapCoat: View {
    ...
    ////            if SandMF.Coat3PtA == 0
    ////            {
    ////                TSAC3.covRate = 600
    ////                TSBC3.covRate = 600
    ////            }
    ////            // HP clear gloss
    ////            else if SandMF.Coat3PtA == 1
    ////            {
    ////                TSAC3.covRate = 575
    ////                TSBC3.covRate = 575
    ////            }
    ...
    var body: some View {
        VStack {
            HStack {
                Text("Coat 3 Product:")
                    .fontWeight(.bold)
                Picker(selection: $SandMF.Coat3ProductType,
                       label: ZStack {
                    Text("\(products[SandMF.Coat3ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
                ...
                .cornerRadius(5)
                .onChange(of: SandMF.Coat3ProductType) { _ in
                    //                  updateCovRate()
                    checkPUCodes()
                    checkPCoatCodes()
                }
            ...
            HStack {
                Toggle(isOn: $SandMF.Coat3MatAdd, label: {
            ...
            if SandMF.Coat3ProductType == 0
            {
                Text("Top Shelf Epoxy® Part A:")
                    .fontWeight(.bold)
                Picker(selection: $SandMF.Coat3PtA,
                       label: ZStack {
                    Text("\(typesA[SandMF.Coat3PtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
                ...
                Text("Top Shelf Epoxy® Part B:")
                    .fontWeight(.bold)
                Picker(selection: $SandMF.Coat3PtB,
                       label: ZStack {
                    Text("\(typesB[SandMF.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                //             .onChange(of: SandMF.Coat3PtB) { _ in
                //                 CheckCoatChoices()
                //             }
                Text("Top Shelf Epoxy® Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $SandMF.Coat3TSColorant,
                       label: ZStack {
                    Text("\(TSColorantChoices[SandMF.Coat3TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            else if SandMF.Coat3ProductType == 1
            {
                HStack
                {
                    ...
                    .background(Color.gray.opacity(0.2))
                    .cornerRadius(5)
                    .onChange(of: SandMF.Coat3PtA) { _ in
                        checkPCoatCodes()
                    }
                    
                    Picker(selection: $SandMF.Coat3PtB,
                           label: ZStack {
                        Text("\(hardeners[SandMF.Coat3PtB])")
                            .opacity(1)
                        Rectangle()
                            .fill(Color.black)
                            .opacity(0.9)
            ...
            else
            {
                ...
                HStack
                {
                    ...
                    Picker(selection: $SandMF.Coat3TSColorant,
                           label: ZStack {
                        Text("\(UPCColorantChoices[SandMF.Coat3TSColorant])")
                            .opacity(1)
                        Rectangle()
                            .fill(Color.gray)
                            .opacity(0.2)
            ...
            if SandMF.Coat3ProductType != 0 && SandMF.Coat3ProductType != 3
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $SandMF.Coat3PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[SandMF.Coat3PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
            ...
            //            Text("Texture:")
            //                .fontWeight(.bold)
            //            Picker(selection: $SandMF.Coat3Texture,
            //                   label: ZStack {
            //                Text("\(TextureOptions[SandMF.Coat3Texture])")
            //                    .opacity(1)
            //                Rectangle()
            //                    .fill(Color.black)
            //                    .opacity(0.9)
            ...
            //            .background(Color.gray.opacity(0.2))
            //            .cornerRadius(5)
            //            .onChange(of: SandMF.Coat3Texture) { _ in
            //                checkTexture()
            //            }
            ...
            VStack { // Start of coat summary
                ...
                if SandMF.Coat3ProductType == 0
                {
                    ...
                    if SandMF.Coat3PtA == 4 {
                        HStack{
                            Text("\(typesACodes[SandMF.Coat3PtA])")
                                .font(.caption)
                            Spacer()
                            Text("TSE Part A: Ench. Green, 1 gal")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandMF_TSAC3))")
                                .font(.caption)
                        }
                    }
                    else {
                        HStack{
                            Text("\(typesACodes[SandMF.Coat3PtA])")
                                .font(.caption)
                            Spacer()
                            Text("TSE Part A: \(typesA[SandMF.Coat3PtA]), 1 gal")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandMF_TSAC3))")
                                .font(.caption)
                    ...
                    HStack{
                        Text("\(typesBCodes[SandMF.Coat3PtB])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Part B: \(typesB[SandMF.Coat3PtB]), 1/2 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandMF_TSAC3))")
                            .font(.caption)
                    }
                    if SandMF.Coat3TSColorant != 0 {
                        
                        HStack {
                            Text("\(TSColorantCodes[SandMF.Coat3TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandMF.Coat3TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandMF_TSColorantC3))")
                                .font(.caption)
                        }
                ...
                else if SandMF.Coat3ProductType == 1
                {
                    HStack
                    {
                        Text("\(PCoatPtACode)")
                            .font(.caption)
                        Spacer()
                        Text("\(PATypes[SandMF.Coat3PtA]) - \(hardeners[SandMF.Coat3PtB]), 1 gal ")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandMF_TSAC3))")
                            .font(.caption)
                    ...
                    HStack
                    {
                        Text("\(PCoatHardenerCode)")
                            .font(.caption)
                        Spacer()
                        Text("\(PATypes[SandMF.Coat3PtA]) Part B, 1 gal ")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandMF_TSAC3))")
                            .font(.caption)
                ...
                else if SandMF.Coat3ProductType == 2
                {
                    ...
                    HStack
                    {
                        ...
                        if SandMF.Coat3PtA == 0
                        {
                            Text("\(PUTypes[SandMF.Coat3PtA]) - \(hardeners[SandMF.Coat3PtB]) Part A, 1 gal ")
                                .font(.caption)
                        }
                        // Poly HP Gloss
                        else if SandMF.Coat3PtA == 1
                        {
                            Text("\(PUTypes[SandMF.Coat3PtA]) Part A, 1/4 gal ")
                                .font(.caption)
                        }
                        // Poly HP Satin
                        else
                        {
                            Text("\(PUTypes[SandMF.Coat3PtA]) Part A, 1/2 gal ")
                                .font(.caption)
                        }
                        Spacer()
                        Text("\(quant(product: SandMF_TSAC3))")
                    ...
                    HStack
                    {
                        ...
                        if SandMF.Coat3PtA == 0
                        {
                            Text("\(PUTypes[SandMF.Coat3PtA]) Part B, 1/2 gal ")
                                .font(.caption)
                        }
                        else
                        {
                            Text("\(PUTypes[SandMF.Coat3PtA]) Part B, 1 gal ")
                                .font(.caption)
                        }
                        Spacer()
                        Text("\(quant(product: SandMF_TSAC3))")
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        HStack
                        {
                            Text("EX-BRCUVAP6-EA")
                                .font(.caption)
                            Spacer()
                            Text("UPC Part B - \(Text("\(typesB[SandMF.Coat3PtB])") ), 6#")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandMF_TSAC3 ))")
                                .font(.caption)
                    ...
                    if SandMF.Coat3TSColorant != 0
                    {
                        HStack
                        {
                            Text("\(UPCColorantCodes[SandMF.Coat3TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("UPC Colorant - \(UPCColorantChoices[SandMF.Coat3TSColorant]), 4 oz")
                                .font(.caption)
                            Spacer()
                ...
                // poly colorant
                if SandMF.Coat3PColorant != 0 && (SandMF.Coat3ProductType != 0 || SandMF.Coat3ProductType != 3)
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[SandMF.Coat3PColorant])")
                            .font(.caption)
                        Spacer()
                        
                        Text("Poly Colorant - \(PolyColorantChoices[SandMF.Coat3PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandMF_TSColorantC3))")
                            .font(.caption)
        ...
        HStack {
            ...
            Spacer()
            TextField("",value: $SandMF.Coat3Waste, formatter: NumberFormatter())
        ...
        HStack {
            Text("Total:")
            Spacer()
            Text("\(quant(product: SandMF_TSAC3) + SandMF.Coat3Waste) kit(s)")
        }
        .padding()
    }
}
...
struct IndustrialSandMFCoat3_Previews: PreviewProvider {
