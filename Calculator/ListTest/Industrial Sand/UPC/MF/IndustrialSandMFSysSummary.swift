...
struct IndustrialSandMFSysSummary: View {
    ...
    @EnvironmentObject var bCoatCoveSandMFA : stats2
    @EnvironmentObject var bCoatCoveSandMFB : stats2
    @EnvironmentObject var bCoatCoveSandMFColorant : stats2
    @EnvironmentObject var bCoatCoveQuartzTexture : stats2
    
    var BroadcastSandMF = statsBroadcast(product: "Color Quartz", covRate: 0.25, MixRat: 50)
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    ...
                    Text("UPC Part A - RC/TT, 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSA_SandMF) + SandMF.PCoatWaste)")
                        .font(.caption)
                }
                
                HStack{
                    Text("\(upcTypesBCodes[SandMF.PCoatPtB])")
                        .font(.caption)
                    Spacer()
                    Text("UPC Part B - RC/TT \(upcTypesB[SandMF.PCoatPtB]), 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSB_SandMF) + SandMF.PCoatWaste)")
                        .font(.caption)
                }
                ...
                if SandMF.PCoatTSColorant != 0
                {
                    HStack {
                        ...
                        Text("UPC Colorant:  \(UPCColorantChoices[SandMF.PCoatTSColorant]), 4 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSColorant_SandMF) + SandMF.PCoatWaste)")
                            .font(.caption)
                    }
                }
        ...
        VStack { // Start of coat summary
            ...
            HStack{
                ...
                Text("UPC Part A - RC/TT, 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSA_SandMF) + SandMF.BCoatWaste)")
                    .font(.caption)
            }
            
            HStack{
                Text("\(upcTypesBCodes[SandMF.BCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("UPC Part B - RC/TT \(upcTypesB[SandMF.BCoatPtB]), 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSB_SandMF) + SandMF.BCoatWaste)")
                    .font(.caption)
            }
            ...
            if SandMF.BCoatTSColorant != 0
            {
                HStack {
                    ...
                    Text("UPC Colorant:  \(UPCColorantChoices[SandMF.BCoatTSColorant]), 4 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSColorant_SandMF) + SandMF.BCoatWaste)")
                        .font(.caption)
                }
            }
        ...
        VStack { // Start of coat summary
            ...
            HStack {
                ...
                Text("Kretus® Approved Industrial Sand")
                    .font(.caption)
                Spacer()
                Text("\(quantBroadcast(product: BroadcastSandMF) + SandMF.BroadcastWaste)")
                    .font(.caption)
            }
        }
        .background(Color(red:239.0/255.0, green: 243.0/255.0, blue: 244.0/250, opacity: 1.0))
    ...
    struct IndustrialSandMFSysSummary_Previews: PreviewProvider {
