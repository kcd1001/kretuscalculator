...
struct IndustrialSandDBTSSysSummary: View {
    ...
    var body: some View {
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    ...
                    Text("TSE Part A: \(typesA[SandDBTS.MVRPtA]), 1 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSMvr) + SandDBTS.MVRWaste)")
                        .font(.caption)
                }
                
                HStack{
                    Text("\(typesBMVRCodes[SandDBTS.MVRPtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesBMVR[SandDBTS.MVRPtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSMvr) + SandDBTS.MVRWaste)")
                        .font(.caption)
        ...
        SandBroadcast1DBTSSum()
        
        SandBCoat2DBTSSum()
        
        SandBroadcast2DBTSSum()
...
struct IndustrialSandDBTSSysSummary_Previews: PreviewProvider {
