...
var TSA_SandSG = stats(product: "Top Shelf® Epoxy Part A:", covRate: 450, MixRat: 1)
var TSB_SandSG = stats(product: "Top Shelf® Epoxy Part B:", covRate: 450, MixRat: 0.5)
var TSColorant_SandSG = stats(product: "Top Shelf® Epoxy Colorant:", covRate: 450, MixRat: 16)

struct PCoatIndustrialSandSG: View {
    ...
    var body: some View {
        VStack {
            ...
            .padding()
            HStack {
                Toggle(isOn: $SandSG.PCoatSC, label: {
           ...
           Text("Top Shelf Epoxy® Part A:")
            .fontWeight(.bold)
            Picker(selection: $SandSG.PCoatPtA,
                label: ZStack {
                    Text("\(typesA[SandSG.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("Top Shelf Epoxy® Part B:")
             .fontWeight(.bold)
             Picker(selection: $SandSG.PCoatPtB,
                 label: ZStack {
                     Text("\(typesB[SandSG.PCoatPtB])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
             ...
             .background(Color.gray.opacity(0.2))
             .cornerRadius(5)
//             .onChange(of: SandSG.PCoatPtB) { _ in
//                quant(product: TSB)
//             }
            Text("Top Shelf Epoxy® Colorant:")
             .fontWeight(.bold)
             Picker(selection: $SandSG.PCoatTSColorant,
                 label: ZStack {
                     Text("\(TSColorantChoices[SandSG.PCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
                ...
                if SandSG.PCoatTSColorant != 0
                {
                    HStack {
                        Text("\(TSColorantCodes[SandSG.BCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandSG.PCoatTSColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSColorant_SandSG))")
                            .font(.caption)
                    }
                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandSG.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSA_SandSG) + SandSG.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatIndustrialSandSG_Previews: PreviewProvider {
