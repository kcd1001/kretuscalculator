        ...
        VStack {
            ...
            .onChange(of: chip.ThicknessSelection) { _ in
                if chip.ThicknessSelection == 0 {
                    TSABC_SandSG.covRate = 50
                    TSBBC_SandSG.covRate = 50
                    TSColorantBC_SandSG.covRate = 50
                }
                if chip.ThicknessSelection == 1 {
                    TSABC_SandSG.covRate = 35
                    TSBBC_SandSG.covRate = 35
                    TSColorantBC_SandSG.covRate = 35
                }
            }
        }
}
