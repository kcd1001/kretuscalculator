...
var TSA_SandTS = stats(product: "Top Shelf® Epoxy Part A:", covRate: 450, MixRat: 1)
var TSB_SandTS = stats(product: "Top Shelf® Epoxy Part B:", covRate: 450, MixRat: 0.5)
var TSColorant_SandTS = stats(product: "Top Shelf® Epoxy Colorant:", covRate: 450, MixRat: 16)

struct PCoatIndustrialSandTS: View {
    ...
    var body: some View {
        VStack {
            ...
            .padding()
            HStack {
                Toggle(isOn: $SandTS.PCoatSC, label: {
           ...
           Text("Top Shelf Epoxy® Part A:")
            .fontWeight(.bold)
            Picker(selection: $SandTS.PCoatPtA,
                label: ZStack {
                    Text("\(typesA[SandTS.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("Top Shelf Epoxy® Part B:")
             .fontWeight(.bold)
             Picker(selection: $SandTS.PCoatPtB,
                 label: ZStack {
                     Text("\(typesB[SandTS.PCoatPtB])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
...
//             }
            Text("Top Shelf Epoxy® Colorant:")
             .fontWeight(.bold)
             Picker(selection: $SandTS.PCoatTSColorant,
                 label: ZStack {
                     Text("\(TSColorantChoices[SandTS.PCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
                ...
                if SandTS.PCoatTSColorant != 0
                {
                    HStack {
                        Text("\(TSColorantCodes[SandTS.BCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandTS.PCoatTSColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandTS.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSA_SandTS) + SandTS.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatIndustrialSandTS_Previews: PreviewProvider {
