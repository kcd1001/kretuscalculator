...
var sandTS_TSAC3 = stats2(product: "Top Shelf® Epoxy Part A:", covRate: 120, MixRat: 1)
var sandTS_TSBC3 = stats2(product: "Top Shelf® Epoxy Part B:", covRate: 120, MixRat: 0.5)
var sandTS_TSColorantC3 = stats2(product: "Top Shelf® Epoxy Colorant:", covRate: 120, MixRat: 16)

struct IndustrialSandTSCapCoat: View {
...
//    }
    ...
    func checkPCoatCodes() -> Void {
        ...
        if SandTS.Coat3ProductType == 1
        {
            if SandTS.Coat3PtA == 0 && SandTS.Coat3PtB == 0 {
                SandTS.Coat3PtACode = "EX-KPLY72AZ-01"
                SandTS.Coat3PtBCode = "EX-KPLY72B-01"
            }
            else if SandTS.Coat3PtA == 0 && SandTS.Coat3PtB == 1 {
                SandTS.Coat3PtACode = "EX-KPLY72AF-01"
                SandTS.Coat3PtBCode = "EX-KPLY72B-01"
                
            }
            else if SandTS.Coat3PtA == 1 && SandTS.Coat3PtB == 0 {
                SandTS.Coat3PtACode = "EX-KPLY85AZ-01"
                SandTS.Coat3PtBCode = "EX-KPLY85B-01"
            }
            else if SandTS.Coat3PtA == 1 && SandTS.Coat3PtB == 1 {
                SandTS.Coat3PtACode = "EX-KPLY85AF-01"
                SandTS.Coat3PtBCode = "EX-KPLY85B-01"
                
            }
            else if SandTS.Coat3PtA == 2 && SandTS.Coat3PtB == 0 {
                SandTS.Coat3PtACode = "EX-KPLY92AZ-01"
                SandTS.Coat3PtBCode = "EX-KPLY92B-01"
                
            }
            else if SandTS.Coat3PtA == 2 && SandTS.Coat3PtB == 1 {
                SandTS.Coat3PtACode = "EX-KPLY92AF-01"
                SandTS.Coat3PtBCode = "EX-KPLY92B-01"
        ...
        else if SandTS.Coat3ProductType == 2
        {
            // POLY HS EZ
            if SandTS.Coat3PtA == 0 && SandTS.Coat3PtB == 0 {
                SandTS.Coat3PtACode = "EX-KPLYHSAZ-01"
                SandTS.Coat3PtBCode = "EX-KPLYHSB-01"
            }
            // POLY HS FAST
            else if SandTS.Coat3PtA == 0 && SandTS.Coat3PtB == 1 {
                SandTS.Coat3PtACode = "EX-KPLYHSAF-01"
                SandTS.Coat3PtBCode = "EX-KPLYHSB-01"
                
            }
            // POLY HP GLOSS
            else if SandTS.Coat3PtA == 1 {
                SandTS.Coat3PtACode = "EX-KPLYHPGA-01"
                SandTS.Coat3PtBCode = "EX-KPLYHPB-01"
            }
            // POLY HP SATIN
            else if SandTS.Coat3PtA == 2  {
                SandTS.Coat3PtACode = "EX-KPLYHPSA-01"
                SandTS.Coat3PtBCode = "EX-KPLYHPB-01"
    ...
    var body: some View {
        VStack {
            HStack {
                Text("Coat 3 Product:")
                    .fontWeight(.bold)
                Picker(selection: $SandTS.Coat3ProductType,
                       label: ZStack {
                    Text("\(products[SandTS.Coat3ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
 ...
 //               SplashTSFloorInfo()
            ...
            HStack {
                Toggle(isOn: $SandTS.Coat3MatAdd, label: {
            ...
            Text("Top Shelf Epoxy® Part A:")
                .fontWeight(.bold)
            Picker(selection: $SandTS.Coat3PtA,
                   label: ZStack {
                Text("\(typesA[SandTS.Coat3PtA])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            Text("Top Shelf Epoxy® Part B:")
                .fontWeight(.bold)
            Picker(selection: $SandTS.Coat3PtB,
                   label: ZStack {
                Text("\(typesB[SandTS.Coat3PtB])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            //             .onChange(of: SandTS.Coat3PtB) { _ in
            //                 CheckCoatChoices()
            //             }
            Text("Top Shelf Epoxy® Colorant:")
                .fontWeight(.bold)
            Picker(selection: $SandTS.Coat3TSColorant,
                   label: ZStack {
                Text("\(TSColorantChoices[SandTS.Coat3TSColorant])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            else if SandTS.Coat3ProductType == 1
            {
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                .onChange(of: SandTS.Coat3PtA) { _ in
                    checkPCoatCodes()
                }
                
                Picker(selection: $SandTS.Coat3PtB,
                       label: ZStack {
                    Text("\(hardeners[SandTS.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
...
//                        updateCovRate()
            ...
            else
            {
                ...
                Picker(selection: $SandTS.Coat3TSColorant,
                       label: ZStack {
                    Text("\(UPCColorantChoices[SandTS.Coat3TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            if SandTS.Coat3ProductType != 0 && SandTS.Coat3ProductType != 3
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $SandTS.Coat3PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[SandTS.Coat3PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
...
//            Text("Texture:")
//                .fontWeight(.bold)
//            Picker(selection: $SandTS.Coat3Texture,
//                   label: ZStack {
//                Text("\(TextureOptions[SandTS.Coat3Texture])")
//                    .opacity(1)
//                Rectangle()
//                    .fill(Color.black)
//                    .opacity(0.9)
...
//            .background(Color.gray.opacity(0.2))
//            .cornerRadius(5)
//            .onChange(of: SandTS.Coat3Texture) { _ in
//                checkTexture()
//            }
                ...
                if SandTS.Coat3PtA == 4 {
                    HStack{
                        ...
                        Text("TSE Part A: Ench. Green, 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: sandTS_TSAC3))")
                            .font(.caption)
                    }
                }
                else {
                ...
                if SandTS.Coat3TSColorant != 0 {
                        ...
                        HStack {
                            ...
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandTS.Coat3TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: sandTS_TSColorantC3))")
                                .font(.caption)
                        }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandTS.Coat3Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: sandTS_TSAC3) + SandTS.Coat3Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct IndustrialSandTSCoat3_Previews: PreviewProvider {
