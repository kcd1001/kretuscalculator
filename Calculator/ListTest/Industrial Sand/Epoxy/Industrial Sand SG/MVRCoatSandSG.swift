...
struct MVRCoatSandSG: View {
    ...
    var body: some View {
        VStack {
            ...
            .fontWeight(.bold)
            Picker(selection: $SandSG.MVRPtA,
                label: ZStack {
                    Text("\(typesA[SandSG.MVRPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            .cornerRadius(5)
//            .onChange(of: SandSG.PCoatPtA) { _ in
//                quant(product: TSA_TS)
//            }
            Text("Top Shelf Epoxy® Part B:")
             .fontWeight(.bold)
             Picker(selection: $SandSG.MVRPtB,
                 label: ZStack {
                     Text("\(typesB[SandSG.MVRPtB])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
...
//             }
            Text("Top Shelf Epoxy® Colorant:")
             .fontWeight(.bold)
             Picker(selection: $SandSG.MVRTSColorant,
                 label: ZStack {
                     Text("\(TSColorantChoices[SandSG.MVRTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
             ...
             .background(Color.gray.opacity(0.2))
             .cornerRadius(5)
//             .onChange(of: SandSG.PCoatTSColorant) { _ in
...
//             }
            VStack { // Start of coat summary
                ...
                HStack{
                    Text("\(typesBCodes[SandSG.MVRPtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesB[SandSG.MVRPtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSMvr))")
                        .font(.caption)
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandSG.MVRWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSMvr) + SandSG.MVRWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct MVRCoatSandSG_Previews: PreviewProvider {
