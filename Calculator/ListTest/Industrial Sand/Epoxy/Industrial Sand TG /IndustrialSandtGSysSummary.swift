...
struct IndustrialSandTGSysSummary: View {
    ...
    var BroadcastSandTG = statsBroadcast(product: "Color Quartz", covRate: 1, MixRat: 50)
    ...
    var body: some View {
        ...
        VStack
        {
            ...
            HStack{
                Text("\(typesACodes[SandTG.PCoatPtA])")
                    .font(.caption)
                Spacer()
                Text("TSE Part A: \(typesA[SandTG.PCoatPtA]), 1 gal")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSA_QuartzTS) + SandTG.PCoatWaste)")
                    .font(.caption)
            }
            
            HStack{
                Text("\(typesBCodes[SandTG.PCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("Top Shelf® Epoxy Part B: \(typesB[SandTG.PCoatPtB]), 1/2 gal")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSB_QuartzTS) + SandTG.PCoatWaste)")
                    .font(.caption)
            }
            ...
            if SandTG.PCoatSC
            {
                HStack{ // Solvent Cleaner
                    ...
                    Text("Solvent Cleaner, 32 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSA_SandTG))")
                        .font(.caption)
                }
            }
            
            if SandTG.PCoatTSColorant != 0
            {
                HStack {
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    ...
                    Text("TSE Part A: \(typesA[SandTG.MVRPtA]), 1 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSMvr) + SandTG.MVRWaste)")
                        .font(.caption)
                }
                
                HStack{
                    Text("\(typesBMVRCodes[SandTG.MVRPtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesBMVR[SandTG.MVRPtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSMvr) + SandTG.MVRWaste)")
                        .font(.caption)
        ...
        VStack
        {
            ...
            HStack{
                ...
                Text("TSE Part A: \(typesA[SandTG.BCoatPtA]), 1 gal")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSABC_QuartzTS) + SandTG.BCoatWaste)")
                    .font(.caption)
            }
            ...
            HStack{
                ...
                Text("Top Shelf® Epoxy Part B: \(typesB[SandTG.BCoatPtB]), 1/2 gal")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSBBC_QuartzTS) + SandTG.BCoatWaste)")
                    .font(.caption)
            }
            if SandTG.BCoatTSColorant != 0
            {
                HStack {
                    ...
                    Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandTG.BCoatTSColorant]), 16 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSColorantBC_QuartzTS) + SandTG.BCoatWaste)")
                        .font(.caption)
                }
            }
...
struct IndustrialSandTGSysSummary_Previews: PreviewProvider {
