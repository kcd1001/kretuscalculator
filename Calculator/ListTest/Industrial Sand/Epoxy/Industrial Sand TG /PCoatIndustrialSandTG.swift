...
var TSA_SandTG = stats(product: "Top Shelf® Epoxy Part A:", covRate: 450, MixRat: 1)
var TSB_SandTG = stats(product: "Top Shelf® Epoxy Part B:", covRate: 450, MixRat: 0.5)
var TSColorant_SandTG = stats(product: "Top Shelf® Epoxy Colorant:", covRate: 450, MixRat: 16)

struct PCoatIndustrialSandTG: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                Toggle(isOn: $SandTG.PCoatSC, label: {
           ...
           Text("Top Shelf Epoxy® Part A:")
            .fontWeight(.bold)
            Picker(selection: $SandTG.PCoatPtA,
                label: ZStack {
                    Text("\(typesA[SandTG.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("Top Shelf Epoxy® Part B:")
             .fontWeight(.bold)
             Picker(selection: $SandTG.PCoatPtB,
                 label: ZStack {
                     Text("\(typesB[SandTG.PCoatPtB])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
...
//             }
            Text("Top Shelf Epoxy® Colorant:")
             .fontWeight(.bold)
             Picker(selection: $SandTG.PCoatTSColorant,
                 label: ZStack {
                     Text("\(TSColorantChoices[SandTG.PCoatTSColorant])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
                ...
                if SandTG.PCoatTSColorant != 0
                {
                    HStack {
                        Text("\(TSColorantCodes[SandTG.BCoatTSColorant])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandTG.PCoatTSColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: TSColorant_SandTG))")
                            .font(.caption)
                    }
                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandTG.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSA_SandTG) + SandTG.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatIndustrialSandTG_Previews: PreviewProvider {
