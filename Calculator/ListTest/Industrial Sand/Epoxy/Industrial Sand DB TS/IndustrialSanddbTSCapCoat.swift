...
var SandDBTS_TSAC3 = stats2(product: "Top Shelf® Epoxy Part A:", covRate: 120, MixRat: 1)
var SandDBTS_TSBC3 = stats2(product: "Top Shelf® Epoxy Part B:", covRate: 120, MixRat: 0.5)
var SandDBTS_TSColorantC3 = stats2(product: "Top Shelf® Epoxy Colorant:", covRate: 120, MixRat: 16)

struct IndustrialSandDBTSCapCoat: View {
...
////            if SandDBTS.Coat3PtA == 0
////            {
////                TSAC3.covRate = 600
////                TSBC3.covRate = 600
////            }
////            // HP clear gloss
////            else if SandDBTS.Coat3PtA == 1
////            {
////                TSAC3.covRate = 575
////                TSBC3.covRate = 575
////            }
...
//    }
    ...
    var body: some View {
        VStack {
            HStack {
                Text("Coat 3 Product:")
                    .fontWeight(.bold)
                Picker(selection: $SandDBTS.Coat3ProductType,
                       label: ZStack {
                    Text("\(products[SandDBTS.Coat3ProductType])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
 ...
 //               SplashTSFloorInfo()
            ...
            HStack {
                Toggle(isOn: $SandDBTS.Coat3MatAdd, label: {
            ...
            Text("Top Shelf Epoxy® Part A:")
                .fontWeight(.bold)
            Picker(selection: $SandDBTS.Coat3PtA,
                   label: ZStack {
                Text("\(typesA[SandDBTS.Coat3PtA])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.black)
                    .opacity(0.9)
            ...
            Text("Top Shelf Epoxy® Part B:")
                .fontWeight(.bold)
            Picker(selection: $SandDBTS.Coat3PtB,
                   label: ZStack {
                Text("\(typesB[SandDBTS.Coat3PtB])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            .background(Color.gray.opacity(0.2))
            .cornerRadius(5)
            //             .onChange(of: SandDBTS.Coat3PtB) { _ in
            //                 CheckCoatChoices()
            //             }
            Text("Top Shelf Epoxy® Colorant:")
                .fontWeight(.bold)
            Picker(selection: $SandDBTS.Coat3TSColorant,
                   label: ZStack {
                Text("\(TSColorantChoices[SandDBTS.Coat3TSColorant])")
                    .opacity(1)
                Rectangle()
                    .fill(Color.gray)
                    .opacity(0.2)
            ...
            else if SandDBTS.Coat3ProductType == 1
            {
                ...
                .background(Color.gray.opacity(0.2))
                .cornerRadius(5)
                .onChange(of: SandDBTS.Coat3PtA) { _ in
                    checkPCoatCodes()
                }
                
                Picker(selection: $SandDBTS.Coat3PtB,
                       label: ZStack {
                    Text("\(hardeners[SandDBTS.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
...
//                        updateCovRate()
            ...
            if SandDBTS.Coat3ProductType != 0
            {
                Text("Poly Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $SandDBTS.Coat3PColorant,
                       label: ZStack {
                    Text("\(PolyColorantChoices[SandDBTS.Coat3PColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.black)
                        .opacity(0.9)
...
//            Text("Texture:")
//                .fontWeight(.bold)
//            Picker(selection: $SandDBTS.Coat3Texture,
//                   label: ZStack {
//                Text("\(TextureOptions[SandDBTS.Coat3Texture])")
//                    .opacity(1)
//                Rectangle()
//                    .fill(Color.black)
//                    .opacity(0.9)
...
//            .background(Color.gray.opacity(0.2))
//            .cornerRadius(5)
//            .onChange(of: SandDBTS.Coat3Texture) { _ in
//                checkTexture()
//            }
            ...
            VStack { // Start of coat summary
                ...
                if SandDBTS.Coat3PtA == 4 {
                    HStack{
                        Text("\(typesACodes[SandDBTS.Coat3PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: Ench. Green, 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandDBTS_TSAC3))")
                            .font(.caption)
                    }
                }
                else {
                    HStack{
                        Text("\(typesACodes[SandDBTS.Coat3PtA])")
                            .font(.caption)
                        Spacer()
                        Text("TSE Part A: \(typesA[SandDBTS.Coat3PtA]), 1 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandDBTS_TSAC3))")
                            .font(.caption)
                ...
                HStack{
                    Text("\(typesBCodes[SandDBTS.Coat3PtB])")
                        .font(.caption)
                    Spacer()
                    Text("Top Shelf® Epoxy Part B: \(typesB[SandDBTS.Coat3PtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: SandDBTS_TSAC3))")
                        .font(.caption)
                }
                if SandDBTS.Coat3TSColorant != 0 {

                        HStack {
                            Text("\(TSColorantCodes[SandDBTS.Coat3TSColorant])")
                                .font(.caption)
                            Spacer()
                            Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[SandDBTS.Coat3TSColorant]), 16 oz")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: SandDBTS_TSColorantC3))")
                                .font(.caption)
                        }
            ...
            else if SandDBTS.Coat3ProductType == 1
            {
                HStack
                {
                    Text("\(PCoatPtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[SandDBTS.Coat3PtA]) - \(hardeners[SandDBTS.Coat3PtB]), 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: SandDBTS_TSAC3))")
                        .font(.caption)
                ...
                HStack
                {
                    Text("\(PCoatHardenerCode)")
                        .font(.caption)
                    Spacer()
                    Text("\(PATypes[SandDBTS.Coat3PtA]) Part B, 1 gal ")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: SandDBTS_TSAC3))")
                        .font(.caption)
            ...
            else if SandDBTS.Coat3ProductType == 2
            {
                ...
                HStack
                {
                    ...
                    if SandDBTS.Coat3PtA == 0
                    {
                    Text("\(PUTypes[SandDBTS.Coat3PtA]) - \(hardeners[SandDBTS.Coat3PtB]) Part A, 1 gal ")
                        .font(.caption)
                    }
                    // Poly HP Gloss
                    else if SandDBTS.Coat3PtA == 1
                    {
                    Text("\(PUTypes[SandDBTS.Coat3PtA]) Part A, 1/4 gal ")
                        .font(.caption)
                    }
                    // Poly HP Satin
                    else
                    {
                        Text("\(PUTypes[SandDBTS.Coat3PtA]) Part A, 1/2 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: SandDBTS_TSAC3))")
                ...
                HStack
                {
                    ...
                    if SandDBTS.Coat3PtA == 0
                    {
                    Text("\(PUTypes[SandDBTS.Coat3PtA]) Part B, 1/2 gal ")
                        .font(.caption)
                    }
                    else
                    {
                        Text("\(PUTypes[SandDBTS.Coat3PtA]) Part B, 1 gal ")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: SandDBTS_TSAC3))")
                ...
                // poly colorant
                if SandDBTS.Coat3PColorant != 0 && (SandDBTS.Coat3ProductType != 0 || SandDBTS.Coat3ProductType != 3)
                {
                    HStack
                    {
                        Text("\(PolyColorantCodes[SandDBTS.Coat3PColorant])")
                            .font(.caption)
                        Spacer()
                       
                        Text("Poly Colorant - \(PolyColorantChoices[SandDBTS.Coat3PColorant]), 16 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: SandDBTS_TSColorantC3))")
                            .font(.caption)
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $SandDBTS.Coat3Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: SandDBTS_TSAC3) + SandDBTS.Coat3Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct IndustrialSandDBTSCoat3_Previews: PreviewProvider {
