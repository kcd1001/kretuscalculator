...
struct SandTopCoatDBTSSum: View {
    ...
    func quantTexture(product : stats) -> Int {
        ...
        if SandTS.Coat4Texture > 2 && SandTS.Coat4Texture != 5
        {
            let quantity : Float = (sf.squareF / product.covRate) * product.MixRat
...
struct SandTopCoatDBTSSum_Previews: PreviewProvider {
