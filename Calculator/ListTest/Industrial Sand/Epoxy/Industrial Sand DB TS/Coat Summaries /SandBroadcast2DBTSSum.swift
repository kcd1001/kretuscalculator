...
struct SandBroadcast2DBTSSum: View {
        ...
        VStack { // Start of coat summary
            ...
            HStack {
                ...
                Text("Kretus® Approved \(ChipSizes[SandDBTS.BroadcastSizeSelection]) Industrial Sand")
                    .font(.caption)
                Spacer()
                Text("\(quantBroadcast(product: BroadcastSandDBTS) + SandDBTS.Broadcast2Waste)")
                    .font(.caption)
            }
        }
...
struct SandBroadcast2DBTSSum_Previews: PreviewProvider {
