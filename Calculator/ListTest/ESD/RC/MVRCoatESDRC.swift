...
var TSA_ESDRC = stats(product: "Top Shelf® Epoxy Part A:", covRate: 80, MixRat: 2)
var TSB_ESDRC = stats(product: "Top Shelf® Epoxy Part B:", covRate: 80, MixRat: 1)
var TSColorant_ESDRC = stats(product: "Top Shelf® Epoxy Colorant:", covRate: 80, MixRat: 16)

struct MVRCoatESDRC: View {
...
//                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $ESDRC.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSA_ESDRC) + ESDRC.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct MVRCoatESDRC_Previews: PreviewProvider {
