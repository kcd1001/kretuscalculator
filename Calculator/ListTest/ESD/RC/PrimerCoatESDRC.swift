...
var PrimerA_RC = stats(product: "Top Shelf® Epoxy Part A:", covRate: 160, MixRat: 1)
var PrimerB_RC = stats(product: "Top Shelf® Epoxy Part B:", covRate: 160, MixRat: 1)

struct PrimerCoatESDRC: View {
...
//                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $ESDRC.BCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: PrimerA_RC) + ESDRC.BCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PrimerCoatESDRC_Previews: PreviewProvider {
