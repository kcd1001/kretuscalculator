...
struct ESDSLDissSysSummary: View {
...
//        }
        ...
        VStack { // Start of coat summary
            ...
            HStack{
                Text("\(typesBCodesRC[ESDSL.PCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("UPC Part B - SL/MF \(typesBRC[ESDSL.PCoatPtB]), 8#")
                    .font(.caption)
                Spacer()
...
struct ESDSLDissSysSummary_Previews: PreviewProvider {
