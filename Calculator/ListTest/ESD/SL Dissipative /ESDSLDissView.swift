        ...
        let sf = SquareFeet()
            ...
            ScrollView {
                VStack {
                  ...
                  //  UPC_Colorant_()
                  //    .padding()
                    CoatChoicesESDSLDiss()
                }.navigationBarTitle("ESD Dissipative SL, 3/8\"", displayMode: .inline)
            }
...
struct ESDSLDissView_Previews: PreviewProvider {
