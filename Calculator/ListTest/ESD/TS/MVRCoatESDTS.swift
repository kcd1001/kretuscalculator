...
var TSA_ESDTS = stats(product: "Top Shelf® Epoxy Part A:", covRate: 150, MixRat: 1)
var TSB_ESDTS = stats(product: "Top Shelf® Epoxy Part B:", covRate: 150, MixRat: 0.5)
var TSColorant_ESDTS = stats(product: "Top Shelf® Epoxy Colorant:", covRate: 300, MixRat: 16)

struct MVRCoatESDTS: View {
            ...
            VStack { // Start of coat summary
                ...
                HStack{
                    Text("\(typesBCodes[ESDTS.PCoatPtB])")
                        .font(.caption)
                    Spacer()
                    Text("TSE Part B: \(typesB[ESDTS.PCoatPtB]), 1/2 gal")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: TSB_ESDTS))")
                        .font(.caption)
                }
                if ESDTS.PCoatSC
                {
...
//                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $ESDTS.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: TSA_ESDTS) + ESDTS.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct MVRCoatESDTS_Previews: PreviewProvider {
