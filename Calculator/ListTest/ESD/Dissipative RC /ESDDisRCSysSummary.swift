...
struct ESDDisRCSysSummary: View {
    ...
    let typesBRC = ["AP", "EZ", "FC"]
    let typesBCodesRC = ["EX-KUPCRCA6-EA", "EX-KUPCRZ6-EA", "EX-KUPCRCF6-EA"]
        ...
        VStack { // Start of coat summary
            ...
            HStack{
                ...
                Text("UPC Part A - RC/TT, 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSA_ESDRC) + ESDRC.PCoatWaste)")
                    .font(.caption)
            }
            
            HStack{
                Text("\(typesBCodesRC[ESDRC.PCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("UPC Part B - RC/TT \(typesBRC[ESDRC.PCoatPtB]), 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: TSB_ESDRC) + ESDRC.PCoatWaste)")
                    .font(.caption)
            }
            ...
            VStack { // Start of coat summary
                ...
                HStack {
                    ...
                    Text("Kretus® Approved #30/F-Grade Industrial Sand/Quartz")
                        .font(.caption)
                    Spacer()
                    Text("\(quantBroadcast(product: BroadcastESDRC) + ESDRC.BroadcastWaste)")
                        .font(.caption)
                }
            }
            .background(Color(red:239.0/255.0, green: 243.0/255.0, blue: 244.0/250, opacity: 1.0))
        ...
        VStack { // Start of coat summary
            ...
            HStack{
                ...
                Text("UPC Part A - RC/TT, 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: CapTSA_ESDRC) + ESDRC.Coat3Waste)")
                    .font(.caption)
            }
            ...
            HStack{
                ...
                Text("UPC Part B - RC/TT \(typesBRC[ESDRC.PCoatPtB]), 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: CapTSB_ESDRC) + ESDRC.Coat3Waste)")
                    .font(.caption)
            }
...
struct ESDDisRCSysSummary_Previews: PreviewProvider {
