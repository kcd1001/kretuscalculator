...
struct SysOptionsChipRC: View {
    ...
    @EnvironmentObject var UPCColor : stats
        ...
        func ChipPCoatQuantValues() {
            ...
            ChipRC.QuantPCoatColor = quant(product: TSA) //The amount of part A in prime coat
            }
            else {
                ChipRC.QuantPCoatColor = 0 //The amount of part A in prime coat
            }
            
        }
        func ChipMVRQuantValues() {
            if Chip.isMVR == true {
            ChipRC.QuantMVRPtA = quant(product: TSA) //The amount of part A in prime coat
            ChipRC.QuantMVRPtB = quant(product: TSB) //The amount of part B in prime coat
            ChipRC.QuantMVRColorant = quant(product: TSColorant) //The amount of part C in prime coat
            }
            else {
                ChipRC.QuantMVRPtA = 0 //The amount of part A in prime coat
                ChipRC.QuantMVRPtB = 0 //The amount of part B in prime coat
                ChipRC.QuantMVRColorant = 0 //The amount of part C in prime coat
            }
        }
    var body: some View {
        VStack { // Coat Options
...
struct SysOptionsChipRC_Previews: PreviewProvider {
