...
class ColorChipValues : ObservableObject {
...
var TSA = stats(product: "Top Shelf® Epoxy Part A:", covRate: 150, MixRat: 1)
var TSB = stats(product: "Top Shelf® Epoxy Part B:", covRate: 150, MixRat: 0.5)
var PAPUTC1 = stats(product: "Polyaspartic/Polyurethane", covRate: 300, MixRat: 1 )
var PAPUTC2 = stats2(product: "Polyaspartic/Polyurethane", covRate: 750, MixRat: 1 )



struct CoatChoicesGarage: View {
    ...
    var body: some View {
        ...
        if showingPicker == true && Chip.isPrimeCoat == true {  // Base coat + prime coat
            ...
            if showingPCoat == true {
                PCoatGarage()
                    .environmentObject(TSA)
                    .environmentObject(TSB)
            }
        }
...
struct CoatChoicesGarage_Previews: PreviewProvider {
