...
struct BCoatPicker: View {
    ...
    var body: some View {
            ...
            Picker(selection: $ChipPA.BCoatPtA,
                label: ZStack {
                    Text("\(typesA[ChipPA.BCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            .cornerRadius(5)
            Picker(selection: $ChipPA.BCoatHardener,
                label: ZStack {
                    Text("\(PartAHardeners[ChipPA.BCoatHardener])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
...
struct BCoatPicker_Previews: PreviewProvider {
