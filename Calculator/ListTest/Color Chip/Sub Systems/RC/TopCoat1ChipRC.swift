...
struct TopCoat1ChipRC: View {
    ...
    func checkTC2()  {
        if ChipRC.TCoat2Choice == 3 { //POLY HS
            PAPUTC2.covRate = 560
        }
        else if ChipRC.TCoat2Choice == 4 { //POLY HP CLEAR GLOSS
            PAPUTC2.covRate = 575
        }
        else if ChipRC.TCoat2Choice == 5 { //POLY HP CLEAR SATIN
            PAPUTC2.covRate = 675
        }
        else {
            PAPUTC2.covRate = 750 
    ...
    func checkTC1() { // change tc1 product coverage rate based off selection and chip size 
        if ChipRC.BroadcastSizeSelection == 0 {
            switch ChipRC.TCoat1Choice {
            case 3:
                PAPUTC1.covRate = 210
            default:
                PAPUTC1.covRate = 300
    ...
    if ChipRC.TCoat1Choice == 0 && ChipRC.TCoat1Hardener == 0 {
        TCoat1PtACode = "EX-KPLY72AZ-01"
        TCoat1PtBCode = "EX-KPLY72B-01"
    }
    else if ChipRC.TCoat1Choice == 0 && ChipRC.TCoat1Hardener == 1 {
        TCoat1PtACode = "EX-KPLY72AF-01"
        TCoat1PtBCode = "EX-KPLY72B-01"

    }
    else if ChipRC.TCoat1Choice == 1 && ChipRC.TCoat1Hardener == 0 {
        TCoat1PtACode = "EX-KPLY85AZ-01"
        TCoat1PtBCode = "EX-KPLY85B-01"
    }
    else if ChipRC.TCoat1Choice == 1 && ChipRC.TCoat1Hardener == 1 {
        TCoat1PtACode = "EX-KPLY85AF-01"
        TCoat1PtBCode = "EX-KPLY85B-01"

    }
    else if ChipRC.TCoat1Choice == 2 && ChipRC.TCoat1Hardener == 0 {
        TCoat1PtACode = "EX-KPLY92AZ-01"
        TCoat1PtBCode = "EX-KPLY92B-01"

    }
    else if ChipRC.TCoat1Choice == 2 && ChipRC.TCoat1Hardener == 1 {
        TCoat1PtACode = "EX-KPLY92AF-01"
        TCoat1PtBCode = "EX-KPLY92B-01"

    }
    else if ChipRC.TCoat1Choice == 3 && ChipRC.TCoat1Hardener == 0 {
        TCoat1PtACode = "EX-KPLYHSAZ-01"
        TCoat1PtBCode = "EX-KPLYHSB-EA"
        PAPUTC1.covRate = 210
    }
    else if ChipRC.TCoat1Choice == 3 && ChipRC.TCoat1Hardener == 1 {
        TCoat1PtACode = "EX-KPLYHSAF-01"
        TCoat1PtBCode = "EX-KPLYHSB-EA"
        PAPUTC1.covRate = 210 
    } //END OF TCOAT1
    if ChipRC.TCoat2Choice == 0 && ChipRC.TCoat2Hardener == 0 {
            TCoat2PtACode = "EX-KPLY72AZ-01"
            TCoat2PtBCode = "EX-KPLY72B-01"
        }
    else if ChipRC.TCoat2Choice == 0 && ChipRC.TCoat2Hardener == 1 {
            TCoat2PtACode = "EX-KPLY72AF-01"
            TCoat2PtBCode = "EX-KPLY72B-01"

        }
    else if ChipRC.TCoat2Choice == 1 && ChipRC.TCoat2Hardener == 0 {
            TCoat2PtACode = "EX-KPLY85AZ-01"
            TCoat2PtBCode = "EX-KPLY85B-01"
        }
    else if ChipRC.TCoat2Choice == 1 && ChipRC.TCoat2Hardener == 1 {
            TCoat2PtACode = "EX-KPLY85AF-01"
            TCoat2PtBCode = "EX-KPLY85B-01"

        }
    else if ChipRC.TCoat2Choice == 2 && ChipRC.TCoat2Hardener == 0 {
            TCoat2PtACode = "EX-KPLY92AZ-01"
            TCoat2PtBCode = "EX-KPLY92B-01"

        }
    else if ChipRC.TCoat2Choice == 2 && ChipRC.TCoat2Hardener == 1 {
            TCoat2PtACode = "EX-KPLY92AF-01"
            TCoat2PtBCode = "EX-KPLY92B-01"

        }
    else if ChipRC.TCoat2Choice == 3 && ChipRC.TCoat2Hardener == 0 {
            TCoat2PtACode = "EX-KPLYHSAZ-01"
            TCoat2PtBCode = "EX-KPLYHSB-EA"
        }
    else if ChipRC.TCoat2Choice == 3 && ChipRC.TCoat2Hardener == 1 {
    ...
    var body: some View {
        ...
        Text("Top Coat 1:")
         .fontWeight(.bold)
        HStack {
             Picker(selection: $ChipRC.TCoat1Choice,
                 label: ZStack {
                     Text("\(TopCoat1Options[ChipRC.TCoat1Choice])")
                         .opacity(1)
                     Rectangle()
                         .fill(Color.gray)
                         .opacity(0.2)
             ...
             .cornerRadius(5)
             .onChange(of: ChipRC.TCoat1Choice) { _ in
               checkTC1()
               checkTCoatCodes()
             }
             .onChange(of: ChipRC.TCoat1Hardener) { _ in
               checkTCoatCodes()
             }
             .onChange(of: ChipRC.BroadcastSizeSelection) { _ in
               checkTC1()
             }

            Picker(selection: $ChipRC.TCoat1Hardener,
                label: ZStack {
                    Text("\(TCoat1HardenerOptions[ChipRC.TCoat1Hardener])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            Text("Top Coat 2:")
                .fontWeight(.bold)
            HStack {
                 Picker(selection: $ChipRC.TCoat2Choice,
                     label: ZStack {
                         Text("\(TopCoat2Options[ChipRC.TCoat2Choice])")
                             .opacity(1)
                         Rectangle()
                             .fill(Color.gray)
                             .opacity(0.2)
                 ...
                 .background(Color.gray.opacity(0.2))
                 .cornerRadius(5)
                 .onChange(of: ChipRC.TCoat2Choice) { _ in
                   //checkTC1()
                   new_checkTC2()
                   checkTCoatCodes()
                   checkTexture()
                 }
                 .onChange(of: ChipRC.TCoat2Hardener) { _ in
                   checkTCoatCodes()
                 }
                if ChipRC.TCoat2Choice != 6 && ChipRC.TCoat2Choice != 4 && ChipRC.TCoat2Choice != 5 {
                Picker(selection: $ChipRC.TCoat2Hardener,
                    label: ZStack {
                        Text("\(TCoat2HardenerOptions[ChipRC.TCoat2Hardener])")
                            .opacity(1)
                        Rectangle()
                            .fill(Color.gray)
                            .opacity(0.2)
            ...
            if ChipRC.TCoat2Choice != 6 { //Displays texture if it is selected
            Text("Texture:")
             .fontWeight(.bold)
                Picker(selection: $ChipRC.texture1,
                    label: ZStack {
                        Text("\(TextureOptions[ChipRC.texture1])")
                            .opacity(1)
                        Rectangle()
                            .fill(Color.gray)
                            .opacity(0.2)
            ...
            VStack { // Start of coat summary
                ...
                if (ChipRC.TCoat1Choice != ChipRC.TCoat2Choice) {

                    HStack {
                    Text("\(TCoat1PtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) - \(TCoat1HardenerOptions[ChipRC.TCoat1Hardener]), 1 gal")
                        .font(.caption)
                    Spacer()
                ...
                HStack {
                    Text("\(TCoat1PtBCode)")
                        .font(.caption)
                    Spacer()
                    if ChipRC.TCoat1Choice != 3 {
                    Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) Part B, 1 gal")
                        .font(.caption)
                    }
                    else {
                        Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) Part B, 1/2 gal")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: PAPUTC1))")
                ...
                if ChipRC.TCoat2Choice != 6 { //Displays TC2 products if a second tc is chosen
                HStack {
                    Text("\(TCoat2PtACode)")
                        .font(.caption)
                    Spacer()
                    Text("\(TopCoat2Options[ChipRC.TCoat2Choice]) - \(TCoat2HardenerOptions[ChipRC.TCoat2Hardener]), 1 gal")
                        .font(.caption)
                    Spacer()
                ...
                HStack {
                    ...
                    Spacer()
                    if ChipRC.TCoat2Choice != 3 {
                    Text("\(TopCoat2Options[ChipRC.TCoat2Choice]) Part B, 1 gal")
                        .font(.caption)
                    }
                    else {
                        Text("\(TopCoat2Options[ChipRC.TCoat2Choice]) Part B, 1/2 gal")
                            .font(.caption)
                    }
                    Spacer()
                    Text("\(quant(product: PAPUTC2))")
                ...
                if (ChipRC.TCoat1Choice == ChipRC.TCoat2Choice) && (ChipRC.TCoat1Hardener == ChipRC.TCoat2Hardener) {
                    HStack {
                        Text("\(TCoat1PtACode)")
                            .font(.caption)
                        Spacer()
                ...
                if ChipRC.texture1 != 0 {
                    if ChipRC.texture1 < 5 {
                    HStack {
                        Text("Contact Distributor")
                            .font(.caption)
                        Spacer()
                        Text("\(TextureOptions[ChipRC.texture1]), 10#")
                            .font(.caption)
                        Spacer()
                    ...
                    if ChipRC.texture1 >= 5 {
                        HStack {
                            Text("Contact Distributor")
                                .font(.caption)
                            Spacer()
                            Text("\(TextureOptions[ChipRC.texture1]), 32 oz")
                                .font(.caption)
                            Spacer()
        ...
        HStack {
            ...
            Spacer()
            TextField("",value: $ChipRC.TCoatWaste, formatter: NumberFormatter())
        ...
        HStack {
            Text("Total:")
            Spacer()
            Text("\(quant(product: PAPUTC1) + quant(product: PAPUTC2) + ChipRC.TCoatWaste) kit(s)")
        }
        }
        else {
        HStack {
            Text("Total:")
            Spacer()
            Text("\(quant(product: PAPUTC1) + ChipRC.TCoatWaste) kit(s)")
        }
        }
        }
    }
...
struct TopCoat1ChipRC_Previews: PreviewProvider {
