...
struct SysSummaryPCBCChipRC: View {
    ...
    let TypesBUPC = ["AP", "EZ", "FC"]
    let typesBUPCCodes = ["EX-KUPCRCA6-EA", "EX-KUPCRZ6-EA", "EX-KUPCRCF6-EA"]
        ...
        VStack { // Start of coat summary
            ...
            HStack{ // Part A
                ...
                Text("UPC Part A - RC/TT, 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: UPCA) + ChipRC.PCoatWaste)")
                    .font(.caption)
            }
            HStack{ // Part B
                Text("\(typesBUPCCodes[ChipRC.PCoatPtB])")
                    .font(.caption)
                Spacer()
                Text("UPC Part B - RC/TT \(TypesBUPC[ChipRC.PCoatPtB]), 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: UPCB) + ChipRC.PCoatWaste)")
                    .font(.caption)
            }
            HStack{ // Part C
                Text("EX-KUPCRFC-EA")
                ...
                Text("UPC Part C - RC, 6#")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: UPCC) + ChipRC.PCoatWaste)")
                    .font(.caption)
            }
            ...
            HStack{ // Color
                ...
                Text("UPC Colorant - \(UPCColorantChoices[ChipRC.PCoatColor]), 4 oz")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: UPCColorant) + ChipRC.PCoatWaste)")
                    .font(.caption)
            }
        }
        }
            ...
            VStack {
                ...
                HStack{ // Part A
                    ...
                    Text("UPC Part A - RC/TT, 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: BCoatUPCA) + ChipRC.BCoatWaste)")
                        .font(.caption)
                }
                HStack{ // Part B
                    Text("\(typesBUPCCodes[ChipRC.BCoatPtB])")
                        .font(.caption)
                    Spacer()
                    Text("UPC Part B - RC/TT \(TypesBUPC[ChipRC.BCoatPtB]), 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: BCoatUPCB) + ChipRC.BCoatWaste)")
                        .font(.caption)
                }
                HStack{ // Part C
                    Text("EX-KUPCRFC-EA")
                    ...
                    Text("UPC Part C - RC, 6#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: BCoatUPCC) + ChipRC.BCoatWaste)")
                        .font(.caption)
                }
                ...
                HStack{ // Color
                    ...
                    Text("UPC Colorant - \(UPCColorantChoices[ChipRC.BCoatColor]), 4 oz")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: BCoatUPCColorant) + ChipRC.BCoatWaste)")
                        .font(.caption)
                }
            }
            }
        ...
        VStack { // Top Coat
            ...
            if (ChipRC.TCoat1Choice != ChipRC.TCoat2Choice) {
                ...
                Text("\(TCoat1PtACode)")
                    .font(.caption)
                Spacer()
                Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) - \(TCoat1HardenerOptions[ChipRC.TCoat1Hardener]), 1 gl")
                    .font(.caption)
                Spacer()
                    Text("\(quant(product: PAPUTC1) + ChipRC.TCoatWaste)")
                    .font(.caption)
            }
            ...
            HStack {
                ...
                Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) Part B, 1 gl")
                    .font(.caption)
                }
                else {
                    Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) Part B, 1/2 gl")
                        .font(.caption)
                }
                Spacer()
                Text("\(quant(product: PAPUTC1) + ChipRC.TCoatWaste)")
            ...
            HStack {
                Text("\(TCoat2PtACode)")
                    .font(.caption)
                Spacer()
                Text("\(TopCoat2Options[ChipRC.TCoat2Choice]) - \(TCoat2HardenerOptions[ChipRC.TCoat2Hardener]), 1 gl")
                    .font(.caption)
                Spacer()
                Text("\(quant(product: PAPUTC2) + ChipRC.TCoatWaste)")
                    .font(.caption)
            }
            HStack {
                Text("\(TCoat2PtBCode)")
                ...
                Text("\(TopCoat2Options[ChipRC.TCoat2Choice]) Part B, 1 gl")
                    .font(.caption)
                }
                else {
                    Text("\(TopCoat2Options[ChipRC.TCoat2Choice]) Part B, 1/2 gl")
                        .font(.caption)
                }
                Spacer()
                Text("\(quant(product: PAPUTC2) + ChipRC.TCoatWaste)")
            ...
            if (ChipRC.TCoat1Choice == ChipRC.TCoat2Choice) && (ChipRC.TCoat1Hardener == ChipRC.TCoat2Hardener) {
                HStack {
                    ...
                    Text("\(TopCoat1Options[ChipRC.TCoat1Choice]) - \(TCoat1HardenerOptions[ChipRC.TCoat1Hardener]), 1 gl")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: PAPUTC1) + quant(product: PAPUTC2) + ChipRC.TCoatWaste)")
                        .font(.caption)
                }
                HStack {
                    Text("\(TCoat1PtBCode)")
            ...
            if ChipRC.texture1 != 0 {
                ...
                HStack {
                    ...
                    Text("\(TextureOptions[ChipRC.texture1]), 10#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: ChipTextureAO) + ChipRC.TCoatWaste)")
                        .font(.caption)
                }
            }
                if ChipRC.texture1 >= 5 {
                    HStack {
                        ...
                        Text("\(TextureOptions[ChipRC.texture1]), 32 oz")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: ChipTextureBead) + ChipRC.TCoatWaste)")
                            .font(.caption)
                    }
                }
        }
...
struct SysSummaryPCBCChipRC_Previews: PreviewProvider {
