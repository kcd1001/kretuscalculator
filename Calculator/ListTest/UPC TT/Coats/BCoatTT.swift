...
struct BCoatTT: View {
    ...
    func BCoatQuantValues() {
        upcChoice.BCoatPtA = quant(product: UPCA) //The amount of part A in base coat
        upcChoice.BCoatPtB = quant(product: UPCB) //The amount of part B in base coat
        upcChoice.BCoatPtC = quant(product: UPCC) //The amount of part C in base coat
            ...
            VStack {
               ...
               Text("Choose your speed:")
                ...
                HStack {
                    Text("Total:")
                    Spacer()
                    Text("\(quant(product: UPCA) + upcChoice.BCoatWaste) kit(s)")
                } .padding()
...
struct BCoatTT_Previews: PreviewProvider {
