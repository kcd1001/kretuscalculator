...
struct TSMetallicAccentCoat: View {
 ...
 //           PCoattsMetallicInfo()
            ...
            .frame(maxWidth: .infinity, alignment: .leading)
                ...
                Text("Top Shelf Epoxy® Part B:")
                    .fontWeight(.bold)
                Picker(selection: $tsMetallic.Coat3PtB,
                       label: ZStack {
                    Text("\(typesB[tsMetallic.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
                ...
                Text("Metllic Pigment:")
                    .fontWeight(.bold)
                Picker(selection: $tsMetallic.Coat3TSColorant,
                       label: ZStack {
                    Text("\(pigmentChoices[tsMetallic.Coat3TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            VStack { // Start of coat summary
                HStack {
                    ...
                    HStack{
                        Text("\(typesBCodes[tsMetallic.Coat3PtB])")
                            .font(.caption)
                        Spacer()
                        Text("Top Shelf® Epoxy Part B: \(typesB[tsMetallic.Coat3PtB]), 1/2 gal")
                            .font(.caption)
                        Spacer()
                    ...
                    HStack {
                                Text("\(pigmentCodes[tsMetallic.Coat3TSColorant])")
                                    .font(.caption)
                                Spacer()
                                Text("Metallic Pigment: \(pigmentChoices[tsMetallic.Coat3TSColorant]), 8 oz")
                                    .font(.caption)
                                Spacer()
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: bCoatMetallicTSA) + tsMetallic.Coat3Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct TSMetallicAccentCoat_Previews: PreviewProvider {
