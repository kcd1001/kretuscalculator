...
var selectTSA_EDissipative = stats(product: "Top Shelf® Epoxy Part A:", covRate: 350, MixRat: 2)
var selectTSB_EDissipative = stats(product: "Top Shelf® Epoxy Part B:", covRate: 350, MixRat: 1)

class ColorChipValuesSelectEDissipative : ObservableObject {
...
struct CoatChoicesSelectEDissipative: View {
    ...
    var body: some View {
        ...
        if showingPicker == true && Chip.isPrimeCoat == true {  // Base coat + prime coat
            ...
            if showingPCoat == true {
                PCoatSelectEDissipative()
                    .environmentObject(selectTSA_EDissipative)
                    .environmentObject(selectTSB_EDissipative)
            }
        }
...
struct CoatChoicesSelectEDissipative_Previews: PreviewProvider {
