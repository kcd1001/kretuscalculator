...
var selectTSA_Poly = stats(product: "Top Shelf® Epoxy Part A:", covRate: 350, MixRat: 2)
var selectTSB_Poly = stats(product: "Top Shelf® Epoxy Part B:", covRate: 350, MixRat: 1)

class ColorChipValuesSelectPoly : ObservableObject {
...
struct CoatChoicesSelectPoly: View {
    ...
    var body: some View {
        ...
        if showingPicker == true && Chip.isPrimeCoat == true {  // Base coat + prime coat
            ...
            if showingPCoat == true {
                PCoatSelectPoly()
                    .environmentObject(selectTSA_Poly)
                    .environmentObject(selectTSB_Poly)
            }
        }
...
struct CoatChoicesSelectPoly_Previews: PreviewProvider {
