    ...
    var body: some View {
        VStack {
           ...
           Text("Choose your color:")
            .fontWeight(.bold)
            Picker(selection: $ChipPoly.PCoatPtA,
                label: ZStack {
                    Text("\(kitTypes[ChipPoly.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
...
//             .fontWeight(.bold)
//             Picker(selection: $ChipPoly.PCoatTSColorant,
//                 label: ZStack {
//                     Text("\(TSColorantChoices[ChipPoly.PCoatTSColorant])")
//                         .opacity(1)
//                     Rectangle()
//                         .fill(Color.gray)
//                         .opacity(0.2)
...
//             .cornerRadius(5)
            ...
            VStack { // Start of coat summary
                ...
                HStack {
                        Text("\(kitCodes[ChipPoly.PCoatPtA])")
                            .font(.caption)
                        Spacer()
                    Text("Kretus Select Poly Kit - \(kitTypes[ChipPoly.PCoatPtA])")
                            .font(.caption)
                        Spacer()
...
//                if ChipPoly.PCoatTSColorant != 0 {
//                    HStack {
//                        Text("\(TSColorantCodes[ChipPoly.PCoatTSColorant])")
//                            .font(.caption)
//                        Spacer()
//                        Text("Top Shelf® Epoxy Colorant: \(TSColorantChoices[ChipPoly.PCoatTSColorant]), 16 oz")
//                            .font(.caption)
//                        Spacer()
...
//                            }
//                
//                    if ChipPoly.PCoatTSColorant == 4 { //USED TO ABBREVIATE ENCHANTED GREEN TO FIT ON SCREEN
//                        HStack {
//                            Text("\(TSColorantCodes[ChipPoly.PCoatTSColorant])")
//                                .font(.caption)
//                            Spacer()
...
//                                                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $ChipPoly.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: selectTSA_Poly) + ChipPoly.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatSelectPoly_Previews: PreviewProvider {
