...
struct PCoatSelectEConductive: View {
    ...
    var body: some View {
        VStack {
           ...
           Text("Choose speed:")
            .fontWeight(.bold)
            Picker(selection: $ChipEConductive.PCoatPtA,
                label: ZStack {
                    Text("\(kitTypes[ChipEConductive.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
...
//             .fontWeight(.bold)
//             Picker(selection: $ChipEConductive.PCoatTSColorant,
//                 label: ZStack {
//                     Text("\(TSColorantChoices[ChipEConductive.PCoatTSColorant])")
//                         .opacity(1)
//                     Rectangle()
//                         .fill(Color.gray)
//                         .opacity(0.2)
            ...
            VStack { // Start of coat summary
                ...
                HStack {
                        Text("\(kitCodes[ChipEConductive.PCoatPtA])")
                            .font(.caption)
                        Spacer()
                    Text("Kretus Select Epoxy Conductive Kit - \(kitTypes[ChipEConductive.PCoatPtA])")
                            .font(.caption)
                        Spacer()
...
//                if ChipEConductive.PCoatTSColorant != 0 {
//                    HStack {
//                        Text("\(TSColorantCodes[ChipEConductive.PCoatTSColorant])")
//                            .font(.caption)
//                        Spacer()
//                        Text("Top Shelf® Epoxy Colorant: \(TSColorantChoices[ChipEConductive.PCoatTSColorant]), 16 oz")
//                            .font(.caption)
//                        Spacer()
...
//                            }
//                
//                    if ChipEConductive.PCoatTSColorant == 4 { //USED TO ABBREVIATE ENCHANTED GREEN TO FIT ON SCREEN
//                        HStack {
//                            Text("\(TSColorantCodes[ChipEConductive.PCoatTSColorant])")
//                                .font(.caption)
//                            Spacer()
...
//                                                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $ChipEConductive.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: selectTSA_EConductive) + ChipEConductive.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatSelectEConductive_Previews: PreviewProvider {
