...
var selectTSA_EConductive = stats(product: "Top Shelf® Epoxy Part A:", covRate: 350, MixRat: 2)
var selectTSB_EConductive = stats(product: "Top Shelf® Epoxy Part B:", covRate: 350, MixRat: 1)

class ColorChipValuesSelectEConductive : ObservableObject {
...
struct CoatChoicesSelectEConductive: View {
    ...
    var body: some View {
        ...
        if showingPicker == true && Chip.isPrimeCoat == true {  // Base coat + prime coat
            ...
            if showingPCoat == true {
                PCoatSelectEConductive()
                    .environmentObject(selectTSA_EConductive)
                    .environmentObject(selectTSB_EConductive)
            }
        }
...
struct CoatChoicesSelectEConductive_Previews: PreviewProvider {
