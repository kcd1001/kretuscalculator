...
var selectTSA_PConductive = stats(product: "Top Shelf® Epoxy Part A:", covRate: 350, MixRat: 2)
var selectTSB_PConductive = stats(product: "Top Shelf® Epoxy Part B:", covRate: 350, MixRat: 1)

class ColorChipValuesSelectPConductive : ObservableObject {
...
struct CoatChoicesSelectPConductive: View {
    ...
    var body: some View {
        ...
        if showingPicker == true && Chip.isPrimeCoat == true {  // Base coat + prime coat
            ...
            if showingPCoat == true {
                PCoatSelectPConductive()
                    .environmentObject(selectTSA_PConductive)
                    .environmentObject(selectTSB_PConductive)
            }
        }
...
struct CoatChoicesSelectPConductive_Previews: PreviewProvider {
