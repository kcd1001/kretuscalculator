...
struct PCoatSelectPConductive: View {
        ...
        VStack {
           ...
           Text("Choose speed:")
            ...
            Picker(selection: $ChipPConductive.PCoatPtA,
                label: ZStack {
                    Text("\(kitTypes[ChipPConductive.PCoatPtA])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
...
//             .fontWeight(.bold)
//             Picker(selection: $ChipPConductive.PCoatTSColorant,
//                 label: ZStack {
//                     Text("\(TSColorantChoices[ChipPConductive.PCoatTSColorant])")
//                         .opacity(1)
//                     Rectangle()
//                         .fill(Color.gray)
//                         .opacity(0.2)
...
//                if ChipPConductive.PCoatTSColorant != 0 {
//                    HStack {
//                        Text("\(TSColorantCodes[ChipPConductive.PCoatTSColorant])")
//                            .font(.caption)
//                        Spacer()
//                        Text("Top Shelf® Epoxy Colorant: \(TSColorantChoices[ChipPConductive.PCoatTSColorant]), 16 oz")
//                            .font(.caption)
//                        Spacer()
...
//                            }
//                
//                    if ChipPConductive.PCoatTSColorant == 4 { //USED TO ABBREVIATE ENCHANTED GREEN TO FIT ON SCREEN
//                        HStack {
//                            Text("\(TSColorantCodes[ChipPConductive.PCoatTSColorant])")
//                                .font(.caption)
//                            Spacer()
...
//                                                }
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $ChipPConductive.PCoatWaste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: selectTSA_PConductive) + ChipPConductive.PCoatWaste) kit(s)")
            }
            .padding()
        }
    }
...
struct PCoatSelectPConductive_Previews: PreviewProvider {
