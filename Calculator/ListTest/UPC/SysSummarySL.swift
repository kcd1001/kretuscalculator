...
struct SysSummarySL: View {
                ...
                VStack
                {
                    ...
                    HStack{
                        ...
                        Text("UPC Part A - RC/TT, 6 lbs")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: UPCASL) + upcChoice.PCoatWaste)")
                            .font(.caption)
                    }
                    HStack{
                        ...
                        Spacer()
                        Text("\(quant(product: UPCBSL) + upcChoice.PCoatWaste)")
                            .font(.caption)
                    }
                    HStack{
                        Text("EX-KUPCRFC-EA")
                        ...
                        Text("UPC Part C - RC, 6 lbs")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: UPCCSL) + upcChoice.PCoatWaste)")
                            .font(.caption)
                    }
                    ColorantChoices()
                }
            ...
            VStack
            {
                ...
                HStack{
                    ...
                    Text("UPC Part A - SL/MF, 8 lbs")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: UPCASL) + upcChoice.BCoatWaste)")
                        .font(.caption)
                }
                HStack{
                    ...
                    Spacer()
                    Text("\(quant(product: UPCBSL) + upcChoice.BCoatWaste)")
                        .font(.caption)
                }
                HStack{
                    Text("EX-KUPCSLC2-EA")
                    ...
                    Text("UPC Part C - SL, 25 lbs")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: UPCCSL) + upcChoice.BCoatWaste)")
                        .font(.caption)
                }
                ColorantChoices()
            }
    ...
    struct SysSummarySL_Previews: PreviewProvider {
