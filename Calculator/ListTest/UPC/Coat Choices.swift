...
class sysChoices : ObservableObject {
    ...
    @Published var texture2 : Int = 1 // for texture 2 selection
...
struct DropDownToggle : ToggleStyle {
    func makeBody(configuration: Configuration) -> some View {
        return HStack{
            configuration.label
            Spacer()
...
struct Coat_Choices_Previews: PreviewProvider {
