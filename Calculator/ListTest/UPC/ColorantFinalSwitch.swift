...
struct ColorantFinalSwitch: View {
    ...
    var body: some View {
        HStack { // Colorant
            ...
            if colorant.selection != 0 {
            Spacer()
                Text("\(upcChoiceRC.BCoatColorant + upcChoiceRC.PCoatColorant +  upcChoiceRC.TCoatColorant)")
                    .font(.caption)
            }
            }
...
struct ColorantFinalSwitch_Previews: PreviewProvider {
