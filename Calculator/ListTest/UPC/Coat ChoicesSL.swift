...
class sysChoicesSL : ObservableObject {
...
struct Coat_ChoicesSL: View {
    ...
    func BCoatQuantValues() {
        upcChoice.BCoatPtA = quant(product: UPCASL) + upcChoice.BCoatWaste //The amount of part A in base coat
        upcChoice.BCoatPtB = quant(product: UPCBSL) + upcChoice.BCoatWaste //The amount of part B in base coat
        upcChoice.BCoatPtC = quant(product: UPCCSL) + upcChoice.BCoatWaste //The amount of part C in base coat
    ...
    func PCoatQuantValues() {
        ...
        upcChoice.PCoatPtA = quant(product: UPCASL) + upcChoice.PCoatWaste //The amount of part A in prime coat
        upcChoice.PCoatPtB = quant(product: UPCBSL) + upcChoice.PCoatWaste //The amount of part B in prime coat
        upcChoice.PCoatPtC = quant(product: UPCCSL) + upcChoice.PCoatWaste //The amount of part C in prime coat
    ...
    func TCoatQuantValues() {
        ...
        upcChoice.TCoatPtA = quant(product: UPCASL) + upcChoice.TCoatWaste //The amount of part A in top coat
        upcChoice.TCoatPtB = quant(product: UPCBSL) + upcChoice.TCoatWaste //The amount of part B in top coat
        upcChoice.TCoatPtC = quant(product: UPCCSL) + upcChoice.TCoatWaste //The amount of part C in top coat
    ...
    func CheckTextureQuant() { // used to calculate quantity values
        if upcChoice.texture1 == upcChoice.texture2 {
            ...
            upcChoice.texture1Quant = quant(product: UPCASL)  // The amount of texture 1
            upcChoice.texture2Quant = quant(product: UPCASL)  // The amount of texture 2
...
struct Coat_ChoicesSL_Previews: PreviewProvider {
