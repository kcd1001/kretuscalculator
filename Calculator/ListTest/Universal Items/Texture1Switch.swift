...
struct Texture1Switch: View {
    ...
    func CheckTextureQuant() { // used to calculate quantity values
        ...
        if upcChoice.texture1 == upcChoice.texture2 && upcChoice.texture2 != 0 {
...
struct TextureSwitch_Previews: PreviewProvider {
