...
struct EpoxyCoveChipCCoat: View {
        ...
        HStack {
            ...
            .frame(maxWidth: .infinity, alignment: .leading)
                ...
                Text("Top Shelf Epoxy® Part B:")
                    .fontWeight(.bold)
                Picker(selection: $CoveColorChip.Coat3PtB,
                       label: ZStack {
                    Text("\(typesB[CoveColorChip.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
                ...
                Text("Top Shelf Epoxy® Colorant:")
                    .fontWeight(.bold)
                Picker(selection: $CoveColorChip.Coat3TSColorant,
                       label: ZStack {
                    Text("\(TSColorantChoices[CoveColorChip.Coat3TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $CoveColorChip.Coat3Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: coveChipTSA) + CoveColorChip.Coat3Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct EpoxyCoveChipCCoat_Previews: PreviewProvider {
