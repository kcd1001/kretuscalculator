...
var coveTSA = stats(product: "Top Shelf Epoxy Part A", covRate: 300, MixRat: 1)
var coveTSB = stats(product: "Top Shelf Epoxy Part A", covRate: 300, MixRat: 0.5)
var coveTSColorant = stats(product: "Top Shelf Epoxy Part A", covRate: 300, MixRat: 16)

struct EpoxyCovePCoat: View {
        ...
        HStack {
            ...
            .frame(maxWidth: .infinity, alignment: .leading)
                ...
                Picker(selection: $CoveColor.Coat1TSColorant,
                       label: ZStack {
                    Text("\(TSColorantChoices[CoveColor.Coat1TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
                ...
                HStack {
                    ...
                    HStack {
                                ...
                                Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[CoveColor.Coat1TSColorant]), 16 oz")
                                    .font(.caption)
                                Spacer()
                                Text("\(quant(product: coveTSColorant))")
                                    .font(.caption)
                            }
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: coveTSA) + CoveColor.Coat1Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct EpoxyCovePCoat_Previews: PreviewProvider {
