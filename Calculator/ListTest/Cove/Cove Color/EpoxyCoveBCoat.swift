        ...
        HStack {
            ...
            .frame(maxWidth: .infinity, alignment: .leading)
                ...
                Picker(selection: $CoveColor.Coat2TSColorant,
                       label: ZStack {
                    Text("\(TSColorantChoices[CoveColor.Coat2TSColorant])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
                ...
                HStack {
                    ...
                    Text("QUANTITY")
                        ...
                        HStack{
                            ...
                            Text("TSE Part A - Cove Resin - Clear, 1 gal")
                                .font(.caption)
                            Spacer()
                            Text("\(quant(product: bCoatCoveTSA))")
                                .font(.caption)
                        }
                    ...
                    HStack{
                        ...
                        Text("Top Shelf® Epoxy Part B: \(typesB[CoveColor.Coat2PtB]), 1/2 gal")
                            .font(.caption)
                        Spacer()
                        Text("\(quant(product: bCoatCoveTSB))")
                            .font(.caption)
                    }
                    ...
                    HStack {
                                ...
                                Text("Top Shelf® Epoxy Colorant:  \(TSColorantChoices[CoveColor.Coat2TSColorant]), 16 oz")
                                    .font(.caption)
                                Spacer()
                                Text("\(quant(product: bCoatCoveTSColorant))")
                                    .font(.caption)
                            }
                HStack {
                    ...
                    Text("Texture - Color Quartz Clear, F-Grade, 50#")
                        .font(.caption)
                    Spacer()
                    Text("\(quant(product: bCoatCoveTexture))")
                        .font(.caption)
                }
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: bCoatCoveTSA) + CoveColor.Coat2Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct EpoxyCoveBCoat_Previews: PreviewProvider {
