...
struct EpoxyCoveQuartzCCoat: View {
        ...
        HStack {
            ...
            .frame(maxWidth: .infinity, alignment: .leading)
                ...
                Text("Top Shelf Epoxy® Part B:")
                    .fontWeight(.bold)
                Picker(selection: $CoveColorQuartz.Coat3PtB,
                       label: ZStack {
                    Text("\(typesB[CoveColorQuartz.Coat3PtB])")
                        .opacity(1)
                    Rectangle()
                        .fill(Color.gray)
                        .opacity(0.2)
            ...
            HStack {
                ...
                Spacer()
                TextField("",value: $CoveColorQuartz.Coat3Waste, formatter: NumberFormatter())
            ...
            HStack {
                Text("Total:")
                Spacer()
                Text("\(quant(product: coveQuartzTSA) + CoveColorQuartz.Coat3Waste) kit(s)")
            }
            .padding()
        }
    }
...
struct EpoxyCoveQuartzCCoat_Previews: PreviewProvider {
